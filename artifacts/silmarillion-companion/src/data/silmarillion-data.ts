...
export const chaptersData: Chapter[] = [
  ...
  { id: 6, title: "Quenta Silmarillion VI", subtitle: "De Fëanor y el desencadenamiento de Melkor", description: "Durante el Mediodía de Valinor, nace Fëanor, el más grande y trágico de los Elfos. Rúmil inventó las primeras letras élficas, pero Fëanor las superó con las Tengwar. El parto consumió el espíritu de Míriel, quien se tendió en Lórien y su espíritu partió a Mandos. Finwë se casó de nuevo con Indis, lo cual disgustó a Fëanor y fracturó la casa real Noldor. Melkor cumplió su condena, fue liberado y comenzó a corromper a los Noldor con enseñanzas ocultas, aunque Fëanor nunca trató con él.",
    needToKnow: ["Míriel Serindë murió espiritualmente tras dar a luz a Fëanor: se tendió en Lórien y su espíritu partió a Mandos, dejando a Finwë solo con el hijo", "Fëanor creció como el más hábil de los Noldor: inventó nuevas letras (superando a Rúmil), creó gemas artificiales y desposó a Nerdanel hija de Mahtan", "Finwë se casó por segunda vez con Indis de los Vanyar; Fëanor lo resintió y vivió apartado de sus medio hermanos Fingolfin y Finarfin", "Melkor cumplió su condena de tres edades, pidió perdón, fue apoyado por Nienna, y Manwë le concedió libertad en Valinor", "Melkor codiciaba las gemas de los Noldor y buscaba su amistad para corromperlos; los Noldor escucharon sus enseñanzas, aunque Fëanor nunca trató con él"],
    shouldKnowAfter: ["La muerte espiritual de Míriel es un hecho sin precedentes en Aman: una Elfa que elige abandonar la vida en el Reino Bendecido, lo cual causará debate entre los Valar", "El segundo matrimonio de Finwë fracturó la casa real Noldor; muchos juzgaron que si Finwë no se hubiera casado de nuevo, la historia habría sido distinta", "Manwë perdonó a Melkor porque no había mal en Manwë y no podía comprenderlo; Ulmo no se engañó, y Tulkas nunca olvidó", "Melkor se acercó sobre todo a los Noldor porque los Vanyar sospechaban de él y despreciaba a los Teleri; los Noldor se complacían en el conocimiento oculto", "Fëanor nunca habló con Melkor ni buscó su consejo; trabajaba solo impulsado por su propio fuego interior, aunque Melkor mintió diciendo que lo había instruido"] },
  { id: 7, title: "Quenta Silmarillion VII", subtitle: "De los Silmarils", description: "Fëanor encierra la luz de los Dos Árboles en tres joyas inigualables: los Silmarils. Su creación atrae la atención de Melkor, quien comienza a sembrar odio entre los Elfos. Fëanor prohíbe a otros que toquen sus joyas y pronuncia un terrible juramento.", needToKnow: ["Fëanor forjó los tres Silmarils.", "Estas joyas contenían la luz pura de Laurelin y Telperion.", "Melkor, liberado de sus cadenas, empezó a codiciar las joyas.", "Esparció mentiras para enemistar a los Noldor con los Valar.", "Fëanor desenvainó su espada contra Fingolfin y fue exiliado."], shouldKnowAfter: ["La creación de los Silmarils, aunque hermosa, fue lo que atrajo la atención de Morgoth.", "El orgullo de Fëanor en su obra lo hizo vulnerable a la manipulación de Morgoth.", "Este es el momento en que la tragedia de los Elfos realmente comienza.", "El juramento de recuperar los Silmarils traerá infinito dolor a los Noldor durante edades."] },
...
export const charactersData: Character[] = [
  ...
  { id: "melkor", name: "Melkor / Morgoth", aliases: ["Melkor", "Morgoth", "El Enemigo", "El Señor Oscuro", "El Contramaestro"], race: "Vala corrompido", alignment: "evil", role: "El Señor Oscuro, mayor de los Ainur en poder pero corrompido", description: "El que se alzó en orgullo, deseando crear cosas propias como Ilúvatar, y trajo el mal al mundo. Introdujo tres veces disonancia en la Gran Música, pero incluso su maldad fue incorporada al propósito divino. Tras cumplir su condena en Mandos, fue liberado y comenzó a corromper a los Noldor.", details: "Melkor fue uno de los grandes Ainur, dotado de poder casi igual al de los Valar. En el acto de creación, fue presa de la envidia y el orgullo: deseaba poseer la Llama Imperecedera y crear según su propia voluntad. Introdujo discordancia en la Música de los Ainur en tres ocasiones, buscando destruir los temas de Manwë. A pesar de sus intentos, Ilúvatar incorporó incluso su maldad al propósito supremo. Fue encadenado en Mandos por tres edades. Tras su condena, pidió perdón ante los tronos de los Valar. Nienna apoyó su alegato y Manwë le concedió el perdón, aunque Ulmo no se engañó y Tulkas nunca olvidó su envidia. Melkor ocultó su odio bajo una apariencia de hermosura y bondad. Codiciaba las gemas de los Noldor y buscó sembrar discordia entre ellos con enseñanzas ocultas. Los Noldor lo escucharon, aunque Fëanor nunca trató con él. Tras la caída de Valinor, se convirtió en Morgoth, el Señor Oscuro, y desde Angband atormentó a Elfos y Hombres durante las Primeras Edades.", titles: [{chapter: 0, text: "Vala"}, {chapter: 0, text: "Mayor de los Ainur en Poder"}, {chapter: 6, text: "Liberado tras tres edades"}, {chapter: 6, text: "Sembrador de Discordia"}, {chapter: 9, text: "Señor Oscuro"}, {chapter: 9, text: "El Enemigo"}], notableDeeds: [{chapter: 0, text: "Introdujo discordancia en la Música (tres intentos)"}, {chapter: 0, text: "Buscó poseer la Llama Imperecedera"}, {chapter: 2, text: "Destruyó las Lámparas de los Valar"}, {chapter: 6, text: "Fue liberado tras tres edades en Mandos"}, {chapter: 6, text: "Comenzó a sembrar discordia entre los Noldor"}, {chapter: 9, text: "Robó los Silmarils"}, {chapter: 14, text: "Encadenó a Maedhros"}, {chapter: 22, text: "Maldijo a la casa de Húrin"}], importance: "CRITICAL", firstChapter: 0, relationships: [{characterId: "manwe", type: "enemy"}, {characterId: "iluvatar", type: "father"}, {characterId: "nienna", type: "ally"}], locations: ["Utumno", "Mandos", "Angband", "Vacío Intemporal", "Valinor"], events: ["Creación de los Ainur", "La Gran Música de los Ainur", "La Discordancia de Melkor", "Destrucción de las Lámparas", "Liberación de Mandos", "Corrupción de los Noldor", "Robo de los Silmarils"], greatTales: ["creation-music", "eternal-struggle", "liberacion-melkor", "beren-luthien", "turin", "fall-gondolin"] },
  ...
  { id: "feanor", name: "Fëanor", aliases: ["Curufinwë", "Espíritu de Fuego", "El Contramaestro"], race: "Elfo Noldor", alignment: "neutral", role: "Creador de los Silmarils, mayor de los Noldor", description: "El más sutil de mente y de manos más hábiles entre todos los Noldor. Alto, hermoso, con ojos penetrantes y cabellos negros como plumas de cuervo. Decidido e inquebrantable, impulsado por un fuego secreto desde dentro.", details: "Fëanor nació de Míriel Serindë, cuyo parto agotó toda su fuerza espiritual. Fue el primero en superar a Rúmil, inventor de las letras, creando las Tengwar que llevan su nombre. Creó gemas artificiales de blancura y brillo inigualable, con fuegos azules y plateados, y cristales con los que las cosas distantes podían verse claras. Se casó con Nerdanel hija de Mahtan el herrero, quien logró retenerlo cuando su fuego ardía demasiado. Trabajaba solo, sin pedir consejo a nadie excepto brevemente a Nerdanel. Su resentimiento por el segundo matrimonio de Finwë lo apartó de Fingolfin y Finarfin.", titles: [{chapter: 6, text: "El Gran Forjador"}, {chapter: 6, text: "Inventor de las Tengwar"}, {chapter: 7, text: "Creador de los Silmarils"}], notableDeeds: [{chapter: 6, text: "Inventó nuevas letras, superando la obra de Rúmil"}, {chapter: 6, text: "Creó las primeras gemas artificiales"}], importance: "CRITICAL", firstChapter: 6, relationships: [{characterId: "finwe", type: "child"}, {characterId: "miriel", type: "mother"}, {characterId: "nerdanel", type: "spouse"}], locations: ["Tirion", "Valinor", "Formenos"], events: ["Invención de nuevas letras", "Creación de gemas"], greatTales: ["nacimiento-feanor"] },
  { id: "miriel", name: "Míriel Serindë", aliases: ["La Bordadora", "Serindë"], race: "Elfo Noldor", alignment: "good", role: "Primera esposa de Finwë, madre de Fëanor", description: "Suprema habilidad en tejido y bordado. El parto de Fëanor consumió toda su vitalidad espiritual, llevándola a un destino sin precedentes en Aman.", details: "Míriel fue la primera esposa de Finwë y una artesana de habilidad incomparable. Su parto de Fëanor consumió toda su fuerza espiritual; advirtió a Finwë que nunca volvería a concebir. Se tendió a dormir en los jardines de Lórien, pero su espíritu partió a las estancias de Mandos, abandonando su cuerpo. Su cuerpo permaneció incorrupto, cuidado por las doncellas de Estë bajo los sauces de plata. Finwë la visitó muchas veces, llamándola en vano. Su destino fue debatido por los Valar, pues era sin precedentes que un Elfa eligiera abandonar la vida en el Reino Bendecido.", titles: [{chapter: 6, text: "Primera Reina de los Noldor"}, {chapter: 6, text: "La Bordadora"}], notableDeeds: [{chapter: 6, text: "Su espíritu partió a Mandos tras el parto de Fëanor"}], importance: "HIGH", firstChapter: 6, lastChapter: 6, relationships: [{characterId: "finwe", type: "spouse"}, {characterId: "feanor", type: "child"}], locations: ["Tirion", "Lórien", "Valinor"], events: ["Muerte espiritual de Míriel"], greatTales: ["nacimiento-feanor"] },
  { id: "indis", name: "Indis", aliases: ["Indis la Bella"], race: "Elfo Vanyar", alignment: "good", role: "Segunda esposa de Finwë, madre de Fingolfin y Finarfin", description: "Pariente próxima de Ingwë, Rey Supremo. Alta y de cabellos dorados, hermosa en nada parecida a Míriel. Finwë la amó mucho y fue otra vez dichoso con ella.", details: "Indis de los Vanyar fue la segunda esposa de Finwë. Su matrimonio disgustó profundamente a Fëanor, quien vivió apartado de sus medio hermanos Fingolfin y Finarfin. Los hijos de Indis fueron grandes y gloriosos, especialmente Finarfin y Fingolfin. Su unión fue causa de la fractura de la casa real Noldor, aunque muchos reconocerían después que sin esta segunda unión la historia habría carecido de la grandeza que los hijos de Indis aportaron.",
    titles: [{chapter: 6, text: "Reina de los Noldor (segunda)"}, {chapter: 6, text: "De los Vanyar"}],
    importance: "MEDIUM", firstChapter: 6, relationships: [{characterId: "finwe", type: "spouse"}, {characterId: "fingolfin", type: "child"}, {characterId: "finarfin", type: "child"}, {characterId: "ingwe", type: "sibling"}], locations: ["Tirion", "Valinor"], events: ["Segundo matrimonio de Finwë"], greatTales: ["nacimiento-feanor"] },
  { id: "nerdanel", name: "Nerdanel", aliases: ["Nerdanel la Sabia"], race: "Elfo Noldor", alignment: "good", role: "Esposa de Fëanor, madre de los siete hijos de Fëanor", description: "Hija del gran herrero Mahtan. De firme voluntad pero más paciente que Fëanor. Buscaba comprender las mentes, no dominarlas. Le dio siete hijos.", details: "Nerdanel fue la esposa de Fëanor, y al principio de su matrimonio logró retenerlo cuando el fuego de su corazón ardía demasiado. Su comprensión paciente y sabia fue un contrapeso a la ardiente naturaleza de Fëanor. Fue madre de los siete hijos de Fëanor: Maedhros, Maglor, Celegorm, Caranthir, Curufin, Amrod y Amras. Con el tiempo, ella y Fëanor dejaron de sentirse unidos, especialmente cuando el fuego del Silmaril comenzó a consumir a Fëanor completamente.",
    titles: [{chapter: 6, text: "Reina de los Noldor (Por matrimonio)"}],
    importance: "MEDIUM", firstChapter: 6, relationships: [{characterId: "feanor", type: "spouse"}, {characterId: "mahtan", type: "father"}], locations: ["Tirion", "Valinor"], events: [], greatTales: [] },
  { id: "mahtan", name: "Mahtan", race: "Elfo Noldor", alignment: "good", role: "Gran herrero, maestro de Fëanor", description: "El más amado de Aulë entre los Noldor. Padre de Nerdanel. De habilidad incomparable en la forja de metales y piedra.", importance: "LOW", firstChapter: 6, relationships: [{characterId: "nerdanel", type: "child"}, {characterId: "aule", type: "ally"}], locations: ["Valinor", "Tirion"], events: [], greatTales: [] },
  { id: "rumil", name: "Rúmil", race: "Elfo Noldor", alignment: "good", role: "Maestro de Tirion, inventor de las primeras letras élficas", description: "Primero en idear signos adecuados para registrar el discurso y las canciones de los Elfos. Inventó letras para grabar en metal, piedra, y para dibujar con pluma. Fëanor superó su obra.", importance: "LOW", firstChapter: 6, relationships: [], locations: ["Tirion", "Valinor"], events: ["Invención de las primeras letras"], greatTales: [] }
];
...
export const locationsData: Location[] = [
  ...
  { id: "lorien", name: "Lórien (Jardines de Irmo)", aliases: ["Jardines de Irmo", "Los Prados Dorados"], description: "El más hermoso de todos los lugares del mundo. Habitado por muchos espíritus. Contiene el lago de Lórellin. Incluso los Valar acuden allí por reposo. Olórin vivía en estos jardines.", importance: "MEDIUM", type: "Other", region: "Aman", status: "Active", firstChapter: 1, lastChapter: 1, lat: -20, lng: -58, relatedCharacters: ["irmo", "este", "olorin"], relatedEvents: [], greatTales: [] },
