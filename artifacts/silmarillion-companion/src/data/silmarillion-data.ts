...
export const charactersData: Character[] = [
  ...
  { id: "melkor", name: "Melkor / Morgoth", aliases: ["Melkor", "Morgoth", "El Enemigo", "El Señor Oscuro", "El Contramaestro"], race: "Vala corrompido", alignment: "evil", role: "El Señor Oscuro, mayor de los Ainur en poder pero corrompido", description: "El que se alzó en orgullo, deseando crear cosas propias como Ilúvatar, y trajo el mal al mundo. Introdujo tres veces disonancia en la Gran Música, pero incluso su maldad fue incorporada al propósito divino.", details: "Melkor fue uno de los grandes Ainur, dotado de poder casi igual al de los Valar. En el acto de creación, fue presa de la envidia y el orgullo: deseaba poseer la Llama Imperecedera y crear según su propia voluntad. Introdujo discordancia en la Música de los Ainur en tres ocasiones, buscando destruir los temas de Manwë. A pesar de sus intentos, Ilúvatar incorporó incluso su maldad al propósito supremo. Tras liberarse del encarcelamiento, sembró mentiras entre los Noldor, especialmente a Fëanor, afirmando que los Valar los temían. Visitó secretamente Formenos intentando robar los Silmarils pero fue rechazado. Huyó hacia la Tierra Media donde se convertiría en Morgoth, el Señor Oscuro, y desde Angband atormentó a Elfos y Hombres durante las Primeras Edades.", titles: [{chapter: 0, text: "Vala"}, {chapter: 0, text: "Mayor de los Ainur en Poder"}, {chapter: 8, text: "El Sembrador de Mentiras"}, {chapter: 9, text: "Señor Oscuro"}, {chapter: 9, text: "El Enemigo"}], notableDeeds: [{chapter: 0, text: "Introdujo discordancia en la Música (tres intentos)"}, {chapter: 0, text: "Buscó poseer la Llama Imperecedera"}, {chapter: 2, text: "Destruyó las Lámparas de los Valar"}, {chapter: 8, text: "Sembró mentiras entre los Noldor"}, {chapter: 8, text: "Instigó a Fëanor contra Fingolfin"}, {chapter: 8, text: "Visitó Formenos buscando robar los Silmarils"}, {chapter: 8, text: "Fue rechazado por Fëanor y huyó de Valinor"}, {chapter: 9, text: "Robó los Silmarils con ayuda de Ungoliant"}, {chapter: 14, text: "Encadenó a Maedhros"}, {chapter: 22, text: "Maldijo a la casa de Húrin"}], importance: "CRITICAL", firstChapter: 0, relationships: [{characterId: "manwe", type: "enemy"}, {characterId: "iluvatar", type: "father"}, {characterId: "feanor", type: "enemy"}], locations: ["Utumno", "Angband", "Formenos", "Vacío Intemporal"], events: ["Creación de los Ainur", "La Gran Música de los Ainur", "La Discordancia de Melkor", "Destrucción de las Lámparas", "Siembra de mentiras en Valinor", "Visitación secreta a Formenos", "Huida hacia la Tierra Media", "Robo de los Silmarils"], greatTales: ["creation-music", "eternal-struggle", "beren-luthien", "turin", "fall-gondolin"] },
  { id: "varda", name: "Varda", aliases: ["Elbereth", "Reina de las Estrellas"], race: "Vala", alignment: "good", role: "Reina de los Valar, Señora de las Estrellas", description: "La más poderosa entre los Valar y la más reverenciada por los Elfos. Confidente de Manwë en la dirección del mundo.", details: "Varda es la Reina de los Valar, especialista en la creación de luz y estrellas. Bendijo los Silmarils de Fëanor con protección divina: ningún fuego podría dañarlos, ningún poder del Vala (excepto Ilúvatar) podría abrirlos o arrebatarlos.", importance: "CRITICAL", firstChapter: 0, relationships: [{characterId: "manwe", type: "spouse"}, {characterId: "iluvatar", type: "father"}], locations: ["Valinor", "Taniquetil", "Aman", "Ezellohar"], events: ["Creación de los Ainur", "La Gran Música de los Ainur", "Creación de las estrellas", "Bendición de los Silmarils"], greatTales: ["creation-music", "eternal-struggle"] },
  ...
  { id: "feanor", name: "Fëanor", aliases: ["Fëanor", "Phëanor", "El Artesano Máximo"], race: "Elfo Noldor", alignment: "neutral", role: "Creador de los Silmarils, Herrero Supremo de los Noldor", description: "Su ardiente espíritu consumió su vida. Hacedor de grandes obras y de grandes males. El más dotado de todos los Elfos en arte e ingenio, cuyo fuego interior lo consumió.", details: "Fëanor fue el más dotado de los Noldor en arte e ingenio. Nacido de Míriel Serindë, cuya muerte espiritual marcó el comienzo del dolor en la Casa de Finwë. Su maestro fue Mahtan, hijo de Aulë, quien le enseñó los secretos de la forja. Fëanor mejoró la invención de Rúmil, creando los Tengwar, las letras élficas que llevaban su nombre. Sus gemas y obras de arte eran inigualables; incluso los Valar admiraban su destreza. Se casó con Nerdanel, hija del gran herrero Mahtan, cuya naturaleza paciente contrastaba con su temperamento ardiente. De su unión nacieron siete hijos: Maedhros, Maglor, Celegorm, Caranthir, Curufin, Amrod y Amras. Creó las tres Silmarils, joyas que capturaban la luz pura de los Dos Árboles de Valinor. Corrompido por las mentiras de Melkor, amenazó a su hermano Fingolfin en la plaza de Tirion, por lo cual fue juzgado por Mandos y exiliado a Formenos. Allí guardó celosamente sus Silmarils y rechazó violentamente a Melkor cuando este intentó robarlos. Su obsesión con estas gemas lo llevó a hacer un terrible juramento: recuperarlas cueste lo que cueste. Aunque su rebelión contra los Valar fue condenada, su legado fue la fuerza que sostuvo la resistencia élfica en la Tierra Media.", titles: [{chapter: 7, text: "El Gran Forjador"}, {chapter: 7, text: "Creador de los Tengwar"}, {chapter: 8, text: "Creador de los Silmarils"}, {chapter: 8, text: "El Exiliado"}, {chapter: 9, text: "Rey de los Noldor"}], notableDeeds: [{chapter: 7, text: "Mejoró los Tengwar inventados por Rúmil"}, {chapter: 7, text: "Se casó con Nerdanel, hija de Mahtan"}, {chapter: 8, text: "Forjó los tres Silmarils bajo la guía de Varda"}, {chapter: 8, text: "Amenazó a Fingolfin con su espada en Tirion"}, {chapter: 8, text: "Fue juzgado por Mandos y exiliado a Formenos"}, {chapter: 8, text: "Rechazó violentamente a Melkor en Formenos"}, {chapter: 9, text: "Pronunció el Juramento de Fëanor"}, {chapter: 9, text: "Lideró la rebelión de los Noldor"}], importance: "CRITICAL", firstChapter: 7, deathInfo: { chapter: 14, description: "Murió a causa de heridas de batalla poco después de llegar a Beleriand, consumido por su fervor obsesivo." }, relationships: [{characterId: "finwe", type: "father"}, {characterId: "miriel", type: "mother"}, {characterId: "fingolfin", type: "sibling"}, {characterId: "finarfin", type: "sibling"}, {characterId: "nerdanel", type: "spouse"}, {characterId: "mahtan", type: "ally"}, {characterId: "melkor", type: "enemy"}], locations: ["Valinor", "Formenos", "Losgar"], events: ["Creación de los Tengwar", "Creación de los Silmarils", "Amenaza a Fingolfin", "Exilio a Formenos", "Confrontación con Melkor en Formenos", "Juramento de Fëanor", "Muerte en la Dagor-nuin-Giliath"], greatTales: ["beren-luthien", "turin", "fall-gondolin"] },
  { id: "fingolfin", name: "Fingolfin", aliases: ["Fingolfin", "Aran Gwarth"], race: "Elfo Noldor", alignment: "good", role: "Rey Supremo de los Noldor en el exilio", description: "Valeroso rey que cruzó el hielo y desafió a Morgoth a duelo singular.", details: "Fingolfin fue el medio hermano de Fëanor y rey de los Noldor después de la muerte de su padre Finwë. Aunque no fue el principal instigador de la rebelión, cruzó el peligroso Helcaraxë con su pueblo para entrar en la Tierra Media. Fue testigo de la amenaza de Fëanor en la plaza de Tirion y mostró su nobleza al no responder con violencia. Durante el Sitio de Angband, fue el único que se atrevió a retar a Morgoth a combate singular. En ese duelo épico, hirió al Señor Oscuro siete veces antes de caer, una hazaña nunca olvidada.", titles: [{chapter: 8, text: "Príncipe Noble"}, {chapter: 10, text: "Señor de los Noldor"}, {chapter: 14, text: "Rey de Hithlum"}, {chapter: 19, text: "El Valeroso"}], notableDeeds: [{chapter: 8, text: "Presenció la amenaza de Fëanor sin responder con violencia"}, {chapter: 8, text: "Demostró su nobleza durante la discordia en Valinor"}, {chapter: 10, text: "Cruzó el Helcaraxë con su pueblo"}, {chapter: 14, text: "Estableció los reinos de Beleriand"}, {chapter: 19, text: "Retó a Morgoth en duelo singular"}, {chapter: 19, text: "Hirió siete veces al Señor Oscuro"}], importance: "CRITICAL", firstChapter: 7, lastChapter: 19, deathInfo: { chapter: 19, description: "Murió en duelo singular contra Morgoth. Hirió al Señor Oscuro siete veces, pero fue abatido.", killer: "melkor" }, relationships: [{characterId: "finwe", type: "father"}, {characterId: "feanor", type: "sibling"}], locations: ["Valinor", "Hithlum"], events: ["Amenaza de Fëanor en Tirion", "El cruce del Helcaraxë", "Duelo con Morgoth"], greatTales: [] },
