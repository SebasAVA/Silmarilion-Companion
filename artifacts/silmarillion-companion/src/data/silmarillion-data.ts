...
export const charactersData: Character[] = [
  ...
  { id: "elwe-singollo", name: "Elwë Singollo", aliases: ["Singollo", "Mantogrís", "Thingol"], race: "Elfo (Teleri)", alignment: "good", role: "Señor de los Teleri, futuro Rey de Doriath", description: "Tercer embajador. Co-señor de los Teleri (junto con su hermano Olwë). Deseaba volver a Valinor y sentía gran amistad por Finwë. Guió a los Teleri por Eriador hasta Beleriand Oriental durante la Gran Marcha.", details: "Era de estatura mayor que otros Elfos. Quedó sobrecogido por la luz de los Dos Árboles. En la marcha hacia el oeste, guió a los Teleri, siempre el primero en partir; su hermano Olwë era siempre el último.", importance: "HIGH", firstChapter: 4, lastChapter: 5, relationships: [{characterId: "olwe", type: "sibling"}, {characterId: "finwe", type: "ally"}], locations: ["Cuiviénen", "Valinor", "Eriador"], events: ["Oromë descubre a los Elfos", "Tres embajadores visitan Valinor", "La Gran Marcha de los Eldar"], greatTales: ["despertar-batalla-poderes", "gran-marcha-division"] },
  { id: "olwe", name: "Olwë", race: "Elfo (Teleri)", alignment: "good", role: "Co-señor de los Teleri", description: "Hermano de Elwë Singollo. Co-señor de los Teleri. Siempre el último en el camino durante la Gran Marcha. Guió a los Teleri hacia Beleriand tras la separación de muchos con Lenwë.", importance: "MEDIUM", firstChapter: 4, relationships: [{characterId: "elwe-singollo", type: "sibling"}], locations: ["Cuiviénen", "Eriador", "Beleriand"], events: ["Oromë descubre a los Elfos", "La Gran Marcha de los Eldar"], greatTales: ["gran-marcha-division"] },
