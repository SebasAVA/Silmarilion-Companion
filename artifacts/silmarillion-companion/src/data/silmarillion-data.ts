...
export const chaptersData: Chapter[] = [
  ...
  { id: 8, title: "Quenta Silmarillion VII", subtitle: "De los Silmarils y la inquietud de los Noldor", description: "Fëanor forja los Tres Silmarils que capturan la luz pura de los Dos Árboles de Valinor. Varda bendice las joyas con protección divina. Melkor, liberado de sus cadenas, siembra mentiras entre los Noldor, afirmando que los Valar los creen inferiores y actúan por envidia. Instigado por Melkor, Fëanor amenaza a su hermano Fingolfin con la espada en la plaza de Tirion. Los Valar convocan consejo: Mandos condena a Fëanor con una profecía de maldición, mientras Finwë se ve obligado a exiliar a su hijo. Fëanor y sus seguidores se retiran a Formenos, la fortaleza en el norte de Valinor. En la noche oscura, Melkor visita secretamente Formenos, buscando robar los Silmarils de Fëanor, pero es rechazado con violencia. Luego Melkor desaparece de Valinor, huyendo hacia la Tierra Media, dejando al reino en tensión y sospecha.", needToKnow: ["Fëanor forjó los tres Silmarils capturando la luz pura de Telperion y Laurelin, creando joyas inigualables que brillaban con su propia luminancia.", "Varda bendijo los Silmarils con protección mágica: ningún fuego podía dañarlos, ningún poder del Vala (excepto Ilúvatar) podía forzarlos a abrirse o arrebatarlos.", "Melkor, liberado tras tres edades de prisión, siembra mentiras entre los Noldor: afirma que los Valar los temen y desean mantenerlos como vasallos eternos, que Aman es una prisión dorada.", "Fëanor, enceguecido por el orgullo en su obra y la malicia de Melkor, amenaza a su hermano Fingolfin con su espada en la plaza pública de Tirion, y es exiliado junto con sus seguidores.", "Mandos, convocado a consejo, pronuncia una profecía de maldición: a quien quebrantase los Silmarils le seguirían dolor, derrota y pérdida infinita; su ley se cumpliría incluso más allá de la muerte.", "Fëanor se retira con sus leales a Formenos, fortaleza en el norte de Valinor donde guarda los Silmarils bajo vigilancia constante, creyendo que los Valar buscan su destrucción.", "Melkor visita Formenos en la noche, buscando robar los Silmarils, pero es descubierto y rechazado violentamente por Fëanor; en su huida, Melkor desaparece de Valinor rumbo a la Tierra Media.", "El Hado de Mandos es solemne y terrible, pronunciado en autoridad suprema, pues Mandos habla las palabras de Ilúvatar: sus profecías nunca fallan y son ineludibles.", "Con la retirada de Fëanor a Formenos, Aman se oscurece moralmente; la luz de los Dos Árboles continúa, pero la paz se ha roto entre los Hijos de Finwë.", "La ausencia de Melkor en Valinor genera inquietud: los Valar sospechan sus intenciones, pero no comprenden aún la magnitud de la catástrofe que se aproxima."], shouldKnowAfter: ["Los Silmarils no son solo joyas hermosas sino contentedoras de luz divina: su pérdida significará la oscuridad literal sobre el mundo, pues la luz de los Árboles se extinguirá con su robo.", "La bendición de Varda sobre los Silmarils es paradójica: aunque los protege del fuego y la corrupción simple, su inviolabilidad únicamente bajo poder directo de Ilúvatar asegura que solo el Creador Único podría restaurarlos si se perdieran.", "El corazón de Fëanor se divide entre el amor a su obra (que lo enorgullece justamente) y un apego obsesivo que lo hace vulnerable a la manipulación de Melkor, revelando que la virtud sin humildad se torna vicio.", "La enemistad entre Fëanor y Fingolfin, hermanos de una misma casa de Finwë, es semilla de divisiones futuras: la rebelión no será unida sino fracturada en bandos rivales de los Noldor.", "El exilio de Fëanor a Formenos es castigo justo pero también prueba: permanece en Aman, bajo vigilancia, preparándose para una rebelión que transformará el curso de todas las edades.", "Melkor es verdaderamente maligno en su estrategia: no solo busca destruir sino corromper, sembrando desconfianza entre los Hijos de Ilúvatar para que se destruyan a sí mismos.", "La profecía de Mandos encierra una verdad más profunda: incluso la muerte no será escape de la maldición, pues los espíritus de los Noldor estarán atados a Arda hasta cumplir o fallar eternamente en su juramento.", "La retirada de Fëanor a Formenos, aunque es castigo del Valar, permite que guarde más celosamente los Silmarils y se prepare en secreto para la rebelión que planea.", "Ningún Vala intenta verdaderamente detener a Fëanor cuando abandona Valinor en rebelión, pues las palabras de Mandos vinculan al mismo Fëanor a cumplir su destino: un destino de dolor inevitable.", "La partida secreta de Melkor marca el momento en que la Primera Edad cambia de rumbo irrevocablemente: la mayor amenaza nunca enfrentada se prepara en las sombras, y los Noldor, en su orgullo, caminarán directamente hacia la ruina."] },
  { id: 9, title: "Quenta Silmarillion VIII", subtitle: "Del oscurecimiento de Valinor", description: "La venganza de Melkor se cierne sobre Valinor. Retornó en secreto del sur en alianza con Ungoliant, una criatura de inteligencia malévola en forma de araña gigante que devoraba luz. Juntos cruzaron el Pelóri en la noche oscura por Hyarmentir, el paso del sur. En Valinor, Melkor asistió a la gran fiesta en Taniquetil donde Fëanor y Fingolfin se reconciliaron. Pero Melkor y Ungoliant atacaron Ezellohar donde estaban los Dos Árboles. Los Árboles fueron destruidos, su luz se extinguió para siempre. Una oscuridad absoluta cayó sobre Aman, una no-luz tangible de poder maligno. Melkor asesinó al Rey Finwë en Formenos, robó los Silmarils y huyó con Ungoliant a la Tierra Media. La persecución de Manwë fue en vano; ambos desaparecieron en la penumbra.", needToKnow: ["Melkor regresó del sur en secreto, aliado con Ungoliant, una criatura de oscuridad que devoraba luz.", "Juntos cruzaron el Pelóri por Hyarmentir, el paso más alto del sur, durante la noche oscura de Valinor.", "Asistieron a la Gran Fiesta en Taniquetil donde Fëanor y Fingolfin hicieron las paces, reconciliación que Melkor supo sería brevemente feliz.", "Destruyeron los Dos Árboles en Ezellohar; Telperion y Laurelin murieron para siempre, su luz se extinguió.", "Finwë murió a manos de Melkor en Formenos; los Silmarils fueron robados. Una Oscuridad No-Luz cayó sobre Valinor, una sustancia maligna que nadie podía atravesar."], shouldKnowAfter: ["Los Dos Árboles nunca serían restaurados; su muerte marca el fin de una era de luz en Valinor y el comienzo de la decadencia del Reino Bendecido.", "Las últimas palabras de reconciliación entre Fëanor y Fingolfin fueron: 'Tú conducirás y yo te seguiré', palabras que resonarían para siempre como un peso terrible.", "Finwë fue el único que se quedó en Formenos para guardar los Silmarils, rechazando la invitación a la fiesta; así su muerte fue propiciada por su propia lealtad a su hijo.", "La Oscuridad del Melkor es cosa viva, no mera ausencia de luz: tiene sustancia, peso, intención. Fue tejida por el poder de Ungoliant en torno a su fuga.", "Ungoliant creció inmensamente al devorar la luz de los Árboles; ella fue quien de verdad llevó a cabo el acto de destrucción, no solo Melkor. Su hambre nunca fue saciada."] },
  { id: 10, title: "Quenta Silmarillion IX", subtitle: "De la huida de los Noldor", description: "Tras la destrucción de los Dos Árboles y el robo de los Silmarils, Yavanna implora a Fëanor que devuelva las joyas para restaurar la luz perdida. Fëanor se niega con ira. Morgoth y Ungoliant huyen cruzando el Helcaraxë. Morgoth mata a Finwë, reconstruye Angband y monta los Silmarils en una corona de hierro. Fëanor pronuncia un juramento terrible: él y sus siete hijos se comprometen a recuperar los Silmarils sin importar el costo. Este juramento se convierte en maldición, vinculando a todos a un destino de dolor. Los Noldor se rebelan contra los Valar. Fëanor marcha hacia el oeste hacia los Puertos de Cielo. En Alqualondë, Fëanor reclama los barcos de los Teleri, quienes se niegan. Ocurre el Kinslaying, el primer fratricidio entre Elfos. Los Noldor queman los barcos en Losgar para que ninguno los siga. Fingolfin y los suyos cruzan el Helcaraxë a pie, con terrible pérdida. Finarfin, escuchando la Profecía del Norte de Mandos, se arrepiente y regresa a Valinor.", needToKnow: ["Yavanna implora a Fëanor que devuelva los Silmarils para que pudiera restaurar la luz de los Dos Árboles, pero Fëanor rehúsa.", "Morgoth cruza el Helcaraxë (el Hielo Crujiente) con Ungoliant y reconstruye Angband, montando los Silmarils en una corona de hierro.", "Fëanor y sus siete hijos pronuncian un Juramento solemne y maldito: recuperar los Silmarils sin importar el costo, incluso en la muerte.", "El Kinslaying de Alqualondë es el primer fratricidio entre Elfos: los Noldor atacan a los Teleri para robar sus barcos.", "Fingolfin y sus huestes, abandonados por Fëanor, cruzan el Helcaraxë a pie en terrible sufrimiento, sufriendo grandes pérdidas.", "Finarfin, al escuchar la Profecía del Norte/Hado de Mandos, se arrepiente de la rebelión y regresa a Valinor con los suyos.", "Los Noldor queman los barcos en Losgar, impidiendo que ninguno más pueda seguirles a través del mar."], shouldKnowAfter: ["El Juramento de Fëanor es verdaderamente maldito: sus palabras tienen poder mágico y vinculan a todos los juramentados a un destino de dolor inevitable.", "Los siete hijos de Fëanor están ahora atados por su juramento; ninguno puede descansar mientras los Silmarils permanezcan perdidos.", "La matanza en Alqualondë es el primer crimen de los Noldor en la Tierra Media; marca el comienzo de su maldición.", "La Profecía de Mandos pronuncia que los Noldor sufrirán más por su propia obsesión que por cualquier enemigo externo.", "La quema de los barcos en Losgar es tanto acto de determinación como acto de destrucción: cierra el camino de regreso a Valinor.", "El sufrimiento de Fingolfin cruzando el Helcaraxë prefigura su heroísmo futuro y también su eventual ruina.", "Finarfin es el único que elige sabiamente, arrepintiéndose antes de que sea demasiado tarde; es el único hijo de Finwë que regresa a Valinor.", "Morgoth ahora posee los Silmarils en la Tierra Media, pero no puede disfrutarlos pues su hambre de poder permanece insatisfecha.", "Con la rebelión de los Noldor, la Primera Edad entra en su era más oscura y sangrienta: la Guerra de la Cólera ha comenzado."] },
  { id: 11, title: "Quenta Silmarillion X", subtitle: "De los Sindar", description: "Mientras los Noldor se rebelaban en Valinor, Beleriand florecía bajo el gobierno de Thingol y Melian. En Doriath, el reino protegido por la Cintura de Melian, se erigió Menegroth, las Mil Cavernas, ciudad de esplendor incomparable. Los Enanos de Nogrod y Belegost llegaron a Beleriand, forjando armas de gran poder para los Sindar. Lúthien, la más hermosa de todos los Elfos, nació en Neldoreth de la unión de Thingol y Melian. Al mismo tiempo, Denethor y el pueblo Nandor llegaron a Ossiriand, estableciendo el Linaje de los Elfos Verdes. Daeron, el bardo y sabio, inventó las Cirth (runas). Pero la paz fue efímera: la Primera Batalla de Beleriand enfrentó a los Sindar contra los Orcos, donde Denethor cayó. Melian, percibiendo el peligro venidero, tejió la Cintura de Melian alrededor de Doriath, protegiéndolo con magia incomparable. Este capítulo marca el apogeo de los Sindar antes de las tormentas de la Primera Edad.", needToKnow: ["Thingol y Melian gobernaban los Sindar, los Elfos Grises de Beleriand, desde Menegroth, las Mil Cavernas.", "Menegroth fue construida por los Enanos de Belegost con incomparable destreza, con vastas cámaras y tesoros de piedra.", "Lúthien nació en Neldoreth, hija de Thingol y Melian, la más hermosa de todos los Hijos de Ilúvatar.", "Los Enanos de Nogrod y Belegost forjaron armas y joyas, estableciendo una relación comercial con los Sindar.", "Denethor, hijo de Lenwë, llegó a Ossiriand (la Tierra de los Siete Ríos) con los Nandor que no habían continuado al oeste.", "Daeron, bardo y sabio de Doriath, inventó la Cirth (runas), ampliando la capacidad de la escritura élfica.", "La Primera Batalla de Beleriand enfrentó a Thingol y los Sindar contra los Orcos de Morgoth, muriendo Denethor en Amon Ereb.", "Melian tejió la Girdle de Melian (Cintura de Melian), un cerco mágico de protección absoluta alrededor de Doriath.", "Círdan y los Falathrim mantuvieron los puertos del oeste, Las Falas, seguros y preparados.", "La paz en Beleriand fue frágil, preñada de futuras tragedias, aunque por el momento Doriath permaneció seguro."], shouldKnowAfter: ["Menegroth fue construida originalmente antes de la llegada de los Noldor, demostrando que los Sindar habían alcanzado gran poder y sofisticación.", "La belleza de Lúthien era tal que incluso los Maiar se asombraban; ella heredó tanto el poder élfico como la magia de los Ainur de su madre Melian.", "La relación entre Enanos y Elfos fue compleja: aunque comerciaban y trabajaban juntos, había siempre una tensión subyacente debido a diferencias culturales profundas.", "Denethor fue el primer Noldor (o más bien, el primer Elfo que llegó después de los Noldor) en caer en batalla, prefigurando las muertes futuras.", "La Cintura de Melian no era simplemente un cerco mágico sino un reflejo del poder de Melian misma, imposible de penetrar o eludir sin su permiso.", "Ossiriand, aunque había acogido a los Nandor, permanecería apartado de los eventos principales de la Primera Edad, protegido pero aislado.", "La invención de las Cirth por Daeron fue acto de genio comparable al de Fëanor con los Tengwar, demostrando que la creatividad no se limitaba a Valinor.", "Aunque no lo sabían, la Primera Batalla sería la más de las muchas que vendrían; la paz de Doriath era como el ojo de una tormenta." ] },
...
export const charactersData: Character[] = [
  ...
  { id: "manwe", name: "Manwë", aliases: ["Manwë Sulimo", "Rey de los Valar", "Señor de los Vientos"], race: "Vala", alignment: "good", role: "Rey de Arda, Señor de los Vientos", description: "El más querido por Ilúvatar, comprende mejor que nadie Sus propósitos. Llevó adelante los temas de la Música contra Melkor.", details: "Manwë es el Rey de los Valar y el Señor del Aire y los Vientos. Durante la Gran Música, fue elegido por Ilúvatar para contraponer sus temas a la discordancia de Melkor. Es el instrumento principal de la voluntad divina en Arda. Su autoridad sobre los Ainur es reconocida universalmente, y su lealtad a Ilúvatar es inquebrantable. En el Capítulo 9, convocó la Gran Fiesta en Taniquetil donde Fëanor y Fingolfin se reconciliaron, pero durante la fiesta fue cuando Melkor atacó los Dos Árboles. Manwë sintió su ida y su retorno, percibió el acto de maldad, pero no pudo prevenir completamente el desastre. Tras la destrucción de los Árboles, intentó perseguir a Melkor y Ungoliant, pero ambos desaparecieron en la oscuridad.", titles: [{chapter: 0, text: "Rey de los Valar"}, {chapter: 1, text: "Señor del Aire"}, {chapter: 0, text: "Instrumento de Ilúvatar"}, {chapter: 9, text: "Convocador de la Fiesta"}, {chapter: 9, text: "Perseguidor del Enemigo"}], notableDeeds: [{chapter: 0, text: "Levantó los temas de la Música contra Melkor"}, {chapter: 0, text: "Descendió a Arda para darle forma"}, {chapter: 9, text: "Convocó la Gran Fiesta en Taniquetil"}, {chapter: 9, text: "Sintió la ida de Melkor y su regreso"}, {chapter: 9, text: "Percibió el acto de la destrucción de los Árboles"}, {chapter: 9, text: "Persiguió a Melkor y Ungoliant en vano"}], importance: "CRITICAL", firstChapter: 0, relationships: [{characterId: "varda", type: "spouse"}, {characterId: "iluvatar", type: "father"}], locations: ["Valinor", "Taniquetil", "Aman", "Ezellohar"], events: ["Creación de los Ainur", "La Gran Música de los Ainur", "Descenso a Arda", "Gran Fiesta en Taniquetil", "Destrucción de los Árboles"], greatTales: ["creation-music", "eternal-struggle", "destruccion-dos-arboles"] },
  { id: "melkor", name: "Melkor / Morgoth", aliases: ["Melkor", "Morgoth", "El Enemigo", "El Señor Oscuro", "El Contramaestro"], race: "Vala corrompido", alignment: "evil", role: "El Señor Oscuro, mayor de los Ainur en poder pero corrompido", description: "El que se alzó en orgullo, deseando crear cosas propias como Ilúvatar, y trajo el mal al mundo. Introdujo tres veces disonancia en la Gran Música, pero incluso su maldad fue incorporada al propósito divino.", details: "Melkor fue uno de los grandes Ainur, dotado de poder casi igual al de los Valar. En el acto de creación, fue presa de la envidia y el orgullo: deseaba poseer la Llama Imperecedera y crear según su propia voluntad. Introdujo discordancia en la Música de los Ainur en tres ocasiones, buscando destruir los temas de Manwë. A pesar de sus intentos, Ilúvatar incorporó incluso su maldad al propósito supremo. Tras liberarse del encarcelamiento, sembró mentiras entre los Noldor, especialmente a Fëanor, afirmando que los Valar los temían. Visitó secretamente Formenos intentando robar los Silmarils pero fue rechazado. En su regreso secreto desde el sur, se alió con Ungoliant en Avathar. Juntos cruzaron el Pelóri por Hyarmentir durante la noche oscura. Con la ayuda de Ungoliant, destruyó los Dos Árboles de Valinor en Ezellohar, asesinó al Rey Finwë en Formenos, y robó los Silmarils. Huyó hacia la Tierra Media donde se convertiría en Morgoth, el Señor Oscuro, y desde Angband atormentó a Elfos y Hombres durante las Primeras Edades.", titles: [{chapter: 0, text: "Vala"}, {chapter: 0, text: "Mayor de los Ainur en Poder"}, {chapter: 8, text: "El Sembrador de Mentiras"}, {chapter: 9, text: "Señor Oscuro"}, {chapter: 9, text: "El Enemigo"}, {chapter: 9, text: "Destructor de los Árboles"}], notableDeeds: [{chapter: 0, text: "Introdujo discordancia en la Música (tres intentos)"}, {chapter: 0, text: "Buscó poseer la Llama Imperecedera"}, {chapter: 2, text: "Destruyó las Lámparas de los Valar"}, {chapter: 8, text: "Sembró mentiras entre los Noldor"}, {chapter: 8, text: "Instigó a Fëanor contra Fingolfin"}, {chapter: 8, text: "Visitó Formenos buscando robar los Silmarils"}, {chapter: 8, text: "Fue rechazado por Fëanor y huyó de Valinor"}, {chapter: 9, text: "Se alió con Ungoliant en Avathar"}, {chapter: 9, text: "Cruzó el Pelóri por Hyarmentir"}, {chapter: 9, text: "Asistió a la Gran Fiesta en Taniquetil"}, {chapter: 9, text: "Destruyó los Dos Árboles con Ungoliant"}, {chapter: 9, text: "Asesinó a Finwë en Formenos"}, {chapter: 9, text: "Robó los Silmarils y huyó a la Tierra Media"}, {chapter: 14, text: "Encadenó a Maedhros"}, {chapter: 22, text: "Maldijo a la casa de Húrin"}], importance: "CRITICAL", firstChapter: 0, relationships: [{characterId: "manwe", type: "enemy"}, {characterId: "iluvatar", type: "father"}, {characterId: "feanor", type: "enemy"}, {characterId: "ungoliant", type: "ally"}], locations: ["Utumno", "Angband", "Formenos", "Avathar", "Ezellohar", "Vacío Intemporal"], events: ["Creación de los Ainur", "La Gran Música de los Ainur", "La Discordancia de Melkor", "Destrucción de las Lámparas", "Siembra de mentiras en Valinor", "Visitación secreta a Formenos", "Huida hacia la Tierra Media", "Alianza con Ungoliant", "Destrucción de los Dos Árboles", "Robo de los Silmarils"], greatTales: ["creation-music", "eternal-struggle", "beren-luthien", "turin", "fall-gondolin", "destruccion-dos-arboles"] },
  { id: "ungoliant", name: "Ungoliant", aliases: ["La Araña", "Glaurungolithe", "La Araña Oscura", "Devorador de Luz"], race: "Espíritu de Oscuridad (Forma de Araña)", alignment: "evil", role: "Aliada de Melkor, Destructora de los Dos Árboles", description: "Criatura de inteligencia malévola en forma de araña gigante. Espíritu de oscuridad que devora luz y era más antigua que los Días. Su hambre era insaciable, tan grande que ni los Árboles podían satisfacerla.", details: "Ungoliant era un espíritu de inteligencia y maldad más antiguo quizás que Melkor mismo. Su forma era la de una araña gigante, pero no era simplemente una bestia sino que poseía inteligencia y voluntad. Habitaba en Avathar, la región oscura al sur del Pelóri, donde ninguna luz llegaba. Su hambre de luz era insaciable: devoraba todo lo que brillaba, toda luminancia. Cuando Melkor llegó a Avathar en su retorno del este, se alió con ella, prometiéndole acceso a la mayor luz de todas: los Dos Árboles de Valinor. Juntos cruzaron las Pelóri por Hyarmentir. En la noche oscura, cuando Melkor estaba en la Gran Fiesta en Taniquetil, Ungoliant atacó Ezellohar. Su hambre fue finalmente parcialmente saciada: bebió la savia de ambos Árboles, devorando su luz, matándolos para siempre. Creció enormemente en tamaño y poder, pero su hambre continuaba. Tras el crimen, Melkor fue con ella huyendo, pero pronto se vieron acosados por la persecución. Ungoliant exigió una parte del botín (los Silmarils), pero Melkor se negó. La araña, ofendida, lo envolvió en su tela. Morgoth gritó, un grito tan terrible que fue escuchado en toda Beleriand. Finalmente, los Balrogs vinieron en su auxilio y la ahuyentaron, pero no antes de que ella le causara gran dolor. Ungoliant desapareció hacia el sur, buscando nuevas pistas de luz que devorar.", titles: [{chapter: 9, text: "La Araña Oscura"}, {chapter: 9, text: "Devorador de Luz"}, {chapter: 9, text: "Compañero del Señor Oscuro"}], notableDeeds: [{chapter: 9, text: "Se alió con Melkor en Avathar"}, {chapter: 9, text: "Cruzó el Pelóri con Melkor"}, {chapter: 9, text: "Destruyó los Dos Árboles en Ezellohar"}, {chapter: 9, text: "Devoró la luz de Telperion y Laurelin"}, {chapter: 9, text: "Creció inmensamente con el poder de los Árboles"}, {chapter: 9, text: "Intentó retener a Melkor tras el robo"}], importance: "CRITICAL", firstChapter: 9, relationships: [{characterId: "melkor", type: "ally"}, {characterId: "manwe", type: "enemy"}], locations: ["Avathar", "Pelóri", "Ezellohar"], events: ["Alianza en Avathar", "Cruce del Pelóri", "Destrucción de los Dos Árboles", "Huida a la Tierra Media"], greatTales: ["destruccion-dos-arboles"] },
  { id: "varda", name: "Varda", aliases: ["Elbereth", "Reina de las Estrellas"], race: "Vala", alignment: "good", role: "Reina de los Valar, Señora de las Estrellas", description: "La más poderosa entre los Valar y la más reverenciada por los Elfos. Confidente de Manwë en la dirección del mundo.", details: "Varda es la Reina de los Valar, especialista en la creación de luz y estrellas. Bendijo los Silmarils de Fëanor con protección divina: ningún fuego podría dañarlos, ningún poder del Vala (excepto Ilúvatar) podría abrirlos o arrebatarlos. En el Capítulo 9, Varda se encontraba en Taniquetil cuando los Dos Árboles fueron destruidos. Desde su montaña, vio la Sombra levantarse sobre Valinor, vio la Oscuridad No-Luz que se extendía como una sustancia maligna. Ella más que ningún otro comprendió la magnitud del desastre, pues fue quien bendijo los Silmarils y quien creó las estrellas que ahora iluminarían la Tierra Media con su luz perdida.", importance: "CRITICAL", firstChapter: 0, relationships: [{characterId: "manwe", type: "spouse"}, {characterId: "iluvatar", type: "father"}], locations: ["Valinor", "Taniquetil", "Aman", "Ezellohar"], events: ["Creación de los Ainur", "La Gran Música de los Ainur", "Creación de las estrellas", "Bendición de los Silmarils", "Oscurecimiento de Valinor"], greatTales: ["creation-music", "eternal-struggle", "destruccion-dos-arboles"] },
  ...
  { id: "finwe", name: "Finwë", race: "Elfo Noldor", alignment: "good", role: "Primer Rey de los Noldor", description: "Lideró a su pueblo a Valinor. Casado primero con Míriel (madre de Fëanor) y luego con Indis de los Vanyar (madre de Fingolfin y Finarfin). Su asesinato precipitó la rebelión de los Noldor.", details: "Finwë fue el primer embajador de los Noldor a Valinor. Tuvo tres hijos de temperamentos distintos: Fëanor de Míriel Serindë, feroz y ardiente; Fingolfin de Indis, fuerte y valiente; Finarfin también de Indis, hermoso y sabio. Finwë lamentaba la separación de los Teleri y la pérdida de Elwë. Reinó sobre los Noldor en Tirion. Cuando Fëanor fue exiliado a Formenos tras amenazar a Fingolfin, Finwë, movido por el amor a su hijo, se retiró con él en solidaridad. En la noche del Oscurecimiento de Valinor, Finwë fue invitado a la Gran Fiesta en Taniquetil pero se negó a asistir, prefiriendo quedarse en Formenos guardando los Silmarils junto a su hijo. Allí fue sorprendido por Morgoth, quien lo mató en el acto de intentar robar las joyas. Su muerte fue el único crimen personal cometido contra uno de los Noldor por mano de Melkor.", titles: [{chapter: 4, text: "Rey de los Noldor"}, {chapter: 6, text: "Padre de Tres Casas"}, {chapter: 8, text: "Guardián del Exilio"}, {chapter: 9, text: "Martir de Formenos"}], notableDeeds: [{chapter: 4, text: "Fue embajador a Valinor"}, {chapter: 6, text: "Reinó sobre los Noldor en Tirion"}, {chapter: 8, text: "Se retiró a Formenos en solidaridad con Fëanor"}, {chapter: 9, text: "Se negó a asistir a la Gran Fiesta"}, {chapter: 9, text: "Guardó los Silmarils en Formenos"}, {chapter: 9, text: "Fue asesinado por Morgoth en Formenos"}], importance: "CRITICAL", firstChapter: 4, lastChapter: 9, deathInfo: { chapter: 9, description: "Asesinado por Morgoth en Formenos cuando el Señor Oscuro llegó a robar los Silmarils. Único crimen personal cometido contra un Noldor." }, relationships: [{characterId: "feanor", type: "child"}, {characterId: "fingolfin", type: "child"}, {characterId: "finarfin", type: "child"}, {characterId: "miriel", type: "spouse"}, {characterId: "indis", type: "spouse"}], locations: ["Valinor", "Tirion", "Formenos"], events: ["Llegada a Valinor", "Retiro a Formenos", "Rechazo de la Gran Fiesta", "Asesinato en Formenos"], greatTales: ["destruccion-dos-arboles"] },
  ...
  { id: "luthien", name: "Lúthien Tinúviel", aliases: ["Lúthien", "Tinúviel", "Nightingale"], race: "Elfa/Maia", alignment: "good", role: "Hija de Thingol y Melian", description: "La más hermosa de todos los Hijos de Ilúvatar.", details: "Lúthien fue la más hermosa de todas las criaturas vivientes. Hija de Thingol, Rey de Doriath, y Melian, una Maia, combinó lo mejor de ambos mundos. Se enamoró de Beren, un mortal proscrito, y desafió a su padre para casarse con él. Juntos lograron arrebatar un Silmaril de la corona de Morgoth, una hazaña que nadie creía posible. En el acto final de su amor, Lúthien eligió volverse mortal para compartir el breve destino de Beren.", titles: [{chapter: 5, text: "Princesa de Doriath"}, {chapter: 5, text: "La Más Hermosa"}, {chapter: 5, text: "Bailadora de los Bosques"}], notableDeeds: [{chapter: 20, text: "Se enamoró de Beren el mortal"}, {chapter: 20, text: "Hizo dormir a Morgoth con su magia"}, {chapter: 20, text: "Logró arrebatar un Silmaril"}, {chapter: 20, text: "Renunció a la inmortalidad por amor"}], importance: "CRITICAL", firstChapter: 5, relationships: [{characterId: "beren", type: "spouse"}, {characterId: "thingol", type: "father"}, {characterId: "melian", type: "mother"}], locations: ["Doriath", "Tol Galen"], events: ["Robo del Silmaril", "Renuncia a la inmortalidad"], greatTales: ["beren-luthien"] },
  { id: "feanor", name: "Fëanor", aliases: ["Fëanor", "Phëanor", "El Artesano Máximo"], race: "Elfo Noldor", alignment: "neutral", role: "Creador de los Silmarils, Herrero Supremo de los Noldor", description: "Su ardiente espíritu consumió su vida. Hacedor de grandes obras y de grandes males. El más dotado de todos los Elfos en arte e ingenio, cuyo fuego interior lo consumió.", details: "Fëanor fue el más dotado de los Noldor en arte e ingenio. Nacido de Míriel Serindë, cuya muerte espiritual marcó el comienzo del dolor en la Casa de Finwë. Su maestro fue Mahtan, hijo de Aulë, quien le enseñó los secretos de la forja. Fëanor mejoró la invención de Rúmil, creando los Tengwar, las letras élficas que llevaban su nombre. Sus gemas y obras de arte eran inigualables; incluso los Valar admiraban su destreza. Se casó con Nerdanel, hija del gran herrero Mahtan, cuya naturaleza paciente contrastaba con su temperamento ardiente. De su unión nacieron siete hijos: Maedhros, Maglor, Celegorm, Caranthir, Curufin, Amrod y Amras. Creó las tres Silmarils, joyas que capturaban la luz pura de los Dos Árboles de Valinor. Corrompido por las mentiras de Melkor, amenazó a su hermano Fingolfin en la plaza de Tirion, por lo cual fue juzgado por Mandos y exiliado a Formenos. Allí guardó celosamente sus Silmarils y rechazó violentamente a Melkor cuando este intentó robarlos. En el Capítulo 9, Fëanor se reconcilió con Fingolfin, y juntos asistieron a la Gran Fiesta en Taniquetil. Pero cuando supo que Melkor había robado los Silmarils y matado a su padre Finwë, su dolor se convirtió en fuego ardiente. Su obsesión con estas gemas lo llevó a hacer un terrible juramento: recuperarlas cueste lo que cueste. Aunque su rebelión contra los Valar fue condenada, su legado fue la fuerza que sostuvo la resistencia élfica en la Tierra Media.", titles: [{chapter: 7, text: "El Gran Forjador"}, {chapter: 7, text: "Creador de los Tengwar"}, {chapter: 8, text: "Creador de los Silmarils"}, {chapter: 8, text: "El Exiliado"}, {chapter: 9, text: "Rey de los Noldor"}, {chapter: 9, text: "El Juramentado"}], notableDeeds: [{chapter: 7, text: "Mejoró los Tengwar inventados por Rúmil"}, {chapter: 7, text: "Se casó con Nerdanel, hija de Mahtan"}, {chapter: 8, text: "Forjó los tres Silmarils bajo la guía de Varda"}, {chapter: 8, text: "Amenazó a Fingolfin con su espada en Tirion"}, {chapter: 8, text: "Fue juzgado por Mandos y exiliado a Formenos"}, {chapter: 8, text: "Rechazó violentamente a Melkor en Formenos"}, {chapter: 9, text: "Se reconcilió con Fingolfin en Taniquetil"}, {chapter: 9, text: "Asistió a la Gran Fiesta en Valinor"}, {chapter: 9, text: "Su padre Finwë asesinado; sus Silmarils robados"}, {chapter: 9, text: "Pronunció el terrible Juramento de Fëanor"}, {chapter: 9, text: "Lideró la rebelión de los Noldor"}], importance: "CRITICAL", firstChapter: 7, deathInfo: { chapter: 14, description: "Murió a causa de heridas de batalla poco después de llegar a Beleriand, consumido por su fervor obsesivo." }, relationships: [{characterId: "finwe", type: "father"}, {characterId: "miriel", type: "mother"}, {characterId: "fingolfin", type: "sibling"}, {characterId: "finarfin", type: "sibling"}, {characterId: "nerdanel", type: "spouse"}, {characterId: "mahtan", type: "ally"}, {characterId: "melkor", type: "enemy"}], locations: ["Valinor", "Formenos", "Losgar", "Taniquetil"], events: ["Creación de los Tengwar", "Creación de los Silmarils", "Amenaza a Fingolfin", "Exilio a Formenos", "Confrontación con Melkor en Formenos", "Reconciliación en Taniquetil", "Robo de los Silmarils", "Juramento de Fëanor", "Muerte en la Dagor-nuin-Giliath"], greatTales: ["beren-luthien", "turin", "fall-gondolin", "destruccion-dos-arboles"] },
  { id: "fingolfin", name: "Fingolfin", aliases: ["Fingolfin", "Aran Gwarth"], race: "Elfo Noldor", alignment: "good", role: "Rey Supremo de los Noldor en el exilio", description: "Valeroso rey que cruzó el hielo y desafió a Morgoth a duelo singular.", details: "Fingolfin fue el medio hermano de Fëanor y rey de los Noldor después de la muerte de su padre Finwë. Aunque no fue el principal instigador de la rebelión, cruzó el peligroso Helcaraxë con su pueblo para entrar en la Tierra Media. Fue testigo de la amenaza de Fëanor en la plaza de Tirion y mostró su nobleza al no responder con violencia. En el Capítulo 9, se reconcilió con Fëanor en Taniquetil durante la Gran Fiesta. En ese momento de paz, Fingolfin pronunció palabras memorables: 'Tú conducirás y yo te seguiré', una promesa que permanecería para siempre. Pero esa noche, los Silmarils fueron robados y Finwë fue asesinado. Durante el Sitio de Angband, fue el único que se atrevió a retar a Morgoth a combate singular. En ese duelo épico, hirió al Señor Oscuro siete veces antes de caer, una hazaña nunca olvidada.", titles: [{chapter: 8, text: "Príncipe Noble"}, {chapter: 9, text: "El Reconciliado"}, {chapter: 10, text: "Señor de los Noldor"}, {chapter: 14, text: "Rey de Hithlum"}, {chapter: 19, text: "El Valeroso"}], notableDeeds: [{chapter: 8, text: "Presenció la amenaza de Fëanor sin responder con violencia"}, {chapter: 8, text: "Demostró su nobleza durante la discordia en Valinor"}, {chapter: 9, text: "Se reconcilió con Fëanor en Taniquetil"}, {chapter: 9, text: "Pronunció el voto: 'Tú conducirás y yo te seguiré'"}, {chapter: 10, text: "Cruzó el Helcaraxë con su pueblo"}, {chapter: 14, text: "Estableció los reinos de Beleriand"}, {chapter: 19, text: "Retó a Morgoth en duelo singular"}, {chapter: 19, text: "Hirió siete veces al Señor Oscuro"}], importance: "CRITICAL", firstChapter: 7, lastChapter: 19, deathInfo: { chapter: 19, description: "Murió en duelo singular contra Morgoth. Hirió al Señor Oscuro siete veces, pero fue abatido.", killer: "melkor" }, relationships: [{characterId: "finwe", type: "father"}, {characterId: "feanor", type: "sibling"}], locations: ["Valinor", "Taniquetil", "Hithlum"], events: ["Amenaza de Fëanor en Tirion", "Reconciliación en Taniquetil", "El cruce del Helcaraxë", "Duelo con Morgoth"], greatTales: [] },
  ...
  { id: "mandos", name: "Mandos / Námo", aliases: ["Námo", "Guardián de las Casas de los Muertos", "Juez de los Valar"], race: "Vala", alignment: "good", role: "Guardián de los espíritus de los muertos", description: "El mayor de los Fëanturi. No olvida nada; conoce todas las cosas que serán, excepto las que dependen de la libertad de Ilúvatar. Condena solo por orden de Manwë.", details: "Mandos es juez de las decisiones de los Valar. Cuando Fëanor amenazó a Fingolfin, fue convocado a consejo y pronunció una profecía de maldición: a quienquiera que quebrantase los Silmarils le seguirían dolor, derrota y pérdida infinita; su ley se cumpliría incluso más allá de la muerte. Esta profecía, pronunciada en la autoridad del mismo Ilúvatar, fue irrevocable e ineludible.", importance: "HIGH", firstChapter: 1, relationships: [{characterId: "nienna", type: "sibling"}, {characterId: "irmo", type: "sibling"}, {characterId: "vaire", type: "spouse"}], locations: ["Valinor", "Mandos"], events: ["Hado de Mandos", "Profecía de Mandos sobre los Silmarils"], greatTales: [] },
  ...
  { id: "orome", name: "Oromë", aliases: ["Aldaron", "Tauron", "Señor de los Bosques"], race: "Vala", alignment: "good", role: "Cazador, Señor de los Bosques", description: "Más terrible en cólera que Tulkas. Amaba la Tierra Media y la dejó de mala gana. Cazador de monstruos y bestias feroces. Ama caballos, perros y árboles.", details: "Su caballo Nahar es blanco al sol, plata por la noche. Su cuerno Valaróma suena como el ascenso del sol envuelto en luz escarlata. En el Capítulo 9, cuando Melkor y Ungoliant huyeron con los Silmarils, Oromë fue uno de los que persiguió, cabalgando en Nahar. Pero ambos perseguidores fueron cegados por la Oscuridad No-Luz que Ungoliant tejía tras de sí, una sustancia maligna que ningún poder podía atravesar directamente. Así la persecución fue en vano, y Melkor escapó hacia Angband con el Silmaril en su posesión.", titles: [{chapter: 1, text: "Señor de los Bosques"}, {chapter: 4, text: "Descubridor de los Elfos"}, {chapter: 9, text: "Perseguidor del Enemigo"}], notableDeeds: [{chapter: 4, text: "Descubrió a los Elfos en Cuiviénen"}, {chapter: 4, text: "Se convirtió en guía amado de los Eldar"}, {chapter: 9, text: "Persiguió a Melkor y Ungoliant"}, {chapter: 9, text: "Fue cegado por la Oscuridad No-Luz"}], importance: "HIGH", firstChapter: 1, relationships: [{characterId: "vana", type: "spouse"}, {characterId: "nessa", type: "sibling"}], locations: ["Valinor", "Tierra Media", "Beleriand"], events: ["Descubrimiento de los Elfos", "Persecución de Melkor y Ungoliant"], greatTales: ["destruccion-dos-arboles"] },
  ...
  { id: "maedhros", name: "Maedhros", aliases: ["Maedhros", "Maitimo", "El Pelirrojo"], race: "Elfo Noldor", alignment: "good", role: "Príncipe de los Noldor, Primogénito de Fëanor", description: "Primero de los siete hijos de Fëanor. Valeroso y noble, fue capturado por Morgoth y rescatado por Fingon. Líder de los Noldor en la Tierra Media tras la muerte de Fëanor.", details: "Maedhros fue el mayor de los siete hijos de Fëanor y Nerdanel. Su nombre original era Maitimo. Tenía cabellos color fuego rojo, de los cuales recibió el nombre de Maedhros. Era noble en corazón y noble en acción, aunque estaba vinculado por el terrible Juramento de Fëanor. En la rebelión de los Noldor, durante los eventos del Capítulo 10, fue capturado por Morgoth en el acto de desembarcar en Beleriand. Morgoth lo torturó y lo encadenó, usándolo como señuelo para atrapar a otros Noldor. Cuando Fingon, hijo de Fingolfin, lo encontró, Maedhros fue rescatado heroicamente. Para escapar, Fingon lo cortó la mano derecha, quedando Maedhros herido pero libre. Nunca se recuperó completamente de sus heridas, pero siguió liderando a los Noldor. Su nobleza natural lo hizo aceptar que Fingolfin fuera Rey Supremo de los Noldor en lugar de rivalizar por el poder. Aunque vinculado al Juramento, intentó mantener la paz entre las casas de los Noldor.", titles: [{chapter: 10, text: "Primogénito de Fëanor"}, {chapter: 10, text: "El Rescatado"}, {chapter: 10, text: "El Pelirrojo"}, {chapter: 14, text: "Señor de Himring"}, {chapter: 14, text: "Líder de los Noldor"}], notableDeeds: [{chapter: 10, text: "Fue capturado por Morgoth en el desembarco"}, {chapter: 10, text: "Fue rescatado por Fingon"}, {chapter: 10, text: "Perdió su mano derecha"}, {chapter: 10, text: "Continuó sirviendo a los Noldor a pesar de sus heridas"}], importance: "HIGH", firstChapter: 10, relationships: [{characterId: "feanor", type: "father"}, {characterId: "nerdanel", type: "mother"}, {characterId: "fingon", type: "ally"}], locations: ["Valinor", "Losgar", "Beleriand", "Himring"], events: ["Juramento de Fëanor", "Captura por Morgoth", "Rescate por Fingon"], greatTales: [] },
  { id: "maglor", name: "Maglor", aliases: ["Maglor el Poderoso Cantor", "Kanafinwë"], race: "Elfo Noldor", alignment: "good", role: "Segundo hijo de Fëanor, gran cantor", description: "Segundo hijo de Fëanor. El más grande cantor entre los Noldor. Poeta y músico.", details: "Maglor fue el segundo de los siete hijos de Fëanor y Nerdanel. Su nombre original era Kanafinwë. Era conocido como el cantor más grande de la época de los Noldor, poseyendo una voz de poder y belleza incomparables. Aunque no alcanzaba el genio de Fëanor en la forja, su talento musical era sublime y sus poesías eran recordadas a través de las edades. Como sus hermanos, fue vinculado por el Juramento de Fëanor, aunque su naturaleza poética lo hizo sufrir más que otros por las tragedias que vendría.", titles: [{chapter: 9, text: "Gran cantor"}, {chapter: 9, text: "Segundo hijo de Fëanor"}, {chapter: 9, text: "Poeta de los Noldor"}], notableDeeds: [{chapter: 9, text: "Hijo de Fëanor"}, {chapter: 9, text: "Reconocido como el cantor más grande"}], importance: "MEDIUM", firstChapter: 9, relationships: [{characterId: "feanor", type: "father"}, {characterId: "nerdanel", type: "mother"}, {characterId: "maedhros", type: "sibling"}, {characterId: "celegorm", type: "sibling"}, {characterId: "caranthir", type: "sibling"}, {characterId: "curufin", type: "sibling"}, {characterId: "amrod", type: "sibling"}, {characterId: "amras", type: "sibling"}], locations: ["Taniquetil", "Valinor"], events: [], greatTales: [] },
  { id: "celegorm", name: "Celegorm", aliases: ["Celegorm el Rubio", "Tyelkormo"], race: "Elfo Noldor", alignment: "good", role: "Tercer hijo de Fëanor", description: "Tercer hijo de Fëanor. Rubio, cazador, amigo de Oromë en Valinor. Compañero de Huan.", details: "Celegorm fue el tercero de los siete hijos de Fëanor y Nerdanel. Su nombre original era Tyelkormo. De cabello rubio y complexión fuerte, era un cazador sin igual, amigo de Oromë en Valinor durante los días de la Paz. Fue compañero del gran perro Huan, el más feroz de todos los perros de Valinor. Su espíritu aventurero y su amor por la caza lo distinguían entre sus hermanos, aunque también compartía su vinculación al Juramento de Fëanor.", titles: [{chapter: 9, text: "Tercer hijo de Fëanor"}, {chapter: 9, text: "El Cazador"}, {chapter: 9, text: "Compañero de Huan"}], notableDeeds: [{chapter: 9, text: "Hijo de Fëanor"}, {chapter: 9, text: "Amigo de Oromë en Valinor"}], importance: "MEDIUM", firstChapter: 9, relationships: [{characterId: "feanor", type: "father"}, {characterId: "nerdanel", type: "mother"}, {characterId: "maedhros", type: "sibling"}, {characterId: "maglor", type: "sibling"}, {characterId: "caranthir", type: "sibling"}, {characterId: "curufin", type: "sibling"}, {characterId: "amrod", type: "sibling"}, {characterId: "amras", type: "sibling"}], locations: ["Taniquetil", "Valinor"], events: [], greatTales: [] },
  { id: "caranthir", name: "Caranthir", aliases: ["Caranthir el Oscuro", "Morifinwë"], race: "Elfo Noldor", alignment: "good", role: "Cuarto hijo de Fëanor", description: "Cuarto hijo de Fëanor. El más duro y menos paciente. De ánimo hosco y colérico.", details: "Caranthir fue el cuarto de los siete hijos de Fëanor y Nerdanel. Su nombre original era Morifinwë. De temperamento más hosco y colérico que sus hermanos, Caranthir era conocido por su falta de paciencia y su dureza de corazón. Aunque no carecía de valor ni de capacidad, su ánimo oscuro lo distinguía entre los Siete. Era experto en cuestiones de comercio y riqueza, y durante su tiempo en la Tierra Media, se vio frecuentemente envuelto en disputas con sus aliados.", titles: [{chapter: 9, text: "Cuarto hijo de Fëanor"}, {chapter: 9, text: "El Oscuro"}, {chapter: 9, text: "De Ánimo Colérico"}], notableDeeds: [{chapter: 9, text: "Hijo de Fëanor"}, {chapter: 9, text: "Conocido por su temperamento hosco"}], importance: "MEDIUM", firstChapter: 9, relationships: [{characterId: "feanor", type: "father"}, {characterId: "nerdanel", type: "mother"}, {characterId: "maedhros", type: "sibling"}, {characterId: "maglor", type: "sibling"}, {characterId: "celegorm", type: "sibling"}, {characterId: "curufin", type: "sibling"}, {characterId: "amrod", type: "sibling"}, {characterId: "amras", type: "sibling"}], locations: ["Taniquetil", "Valinor"], events: [], greatTales: [] },
  { id: "curufin", name: "Curufin", aliases: ["Curufin el Hábil", "Curufinwë"], race: "Elfo Noldor", alignment: "good", role: "Quinto hijo de Fëanor, padre de Celebrimbor", description: "Quinto hijo de Fëanor. El que más se parecía a su padre en apariencia, temperamento y habilidad manual.", details: "Curufin fue el quinto de los siete hijos de Fëanor y Nerdanel. Su nombre original era Curufinwë. De todos los hijos de Fëanor, Curufin fue el que más se asemejaba a su padre en carácter, apariencia y talento. Poseía habilidades excepcionales en el trabajo con metales y gemas, heredando directamente la maestría artesanal de Fëanor. Fue padre de Celebrimbor, quien se convertiría en el más grande herrero de la Segunda Edad. Su dedicación al arte de la forja, aunque no igualaba la del mismo Fëanor, lo mantenía frecuentemente apartado de los asuntos políticos de sus hermanos.", titles: [{chapter: 9, text: "Quinto hijo de Fëanor"}, {chapter: 9, text: "El Hábil"}, {chapter: 9, text: "Padre de Celebrimbor"}], notableDeeds: [{chapter: 9, text: "Hijo de Fëanor"}, {chapter: 9, text: "Engendró a Celebrimbor"}], importance: "MEDIUM", firstChapter: 9, relationships: [{characterId: "feanor", type: "father"}, {characterId: "nerdanel", type: "mother"}, {characterId: "maedhros", type: "sibling"}, {characterId: "maglor", type: "sibling"}, {characterId: "celegorm", type: "sibling"}, {characterId: "caranthir", type: "sibling"}, {characterId: "amrod", type: "sibling"}, {characterId: "amras", type: "sibling"}, {characterId: "celebrimbor", type: "child"}], locations: ["Taniquetil", "Valinor"], events: [], greatTales: [] },
  { id: "amrod", name: "Amrod", aliases: ["Pityafinwë", "Ambarussa"], race: "Elfo Noldor", alignment: "good", role: "Sexto hijo de Fëanor, gemelo de Amras", description: "Sexto hijo de Fëanor. Gemelo de Amras. Los menores de los siete. Grandes cazadores.", details: "Amrod fue el sexto de los siete hijos de Fëanor y Nerdanel. Su nombre original era Pityafinwë, aunque ambos gemelos compartían el nombre de Ambarussa. Como su hermano gemelo Amras, Amrod era uno de los menores de los Siete. Los gemelos eran cazadores excepcionales, heredando la pasión de Celegorm por la caza, aunque menos renombrados que sus hermanos mayores. Juntos, Amrod y Amras representaban una fuerza unida y complementaria en el grupo de los Siete.", titles: [{chapter: 9, text: "Sexto hijo de Fëanor"}, {chapter: 9, text: "Gemelo de Amras"}, {chapter: 9, text: "Gran cazador"}], notableDeeds: [{chapter: 9, text: "Hijo de Fëanor"}, {chapter: 9, text: "Cazador entre los Noldor"}], importance: "LOW", firstChapter: 9, relationships: [{characterId: "feanor", type: "father"}, {characterId: "nerdanel", type: "mother"}, {characterId: "maedhros", type: "sibling"}, {characterId: "maglor", type: "sibling"}, {characterId: "celegorm", type: "sibling"}, {characterId: "caranthir", type: "sibling"}, {characterId: "curufin", type: "sibling"}, {characterId: "amras", type: "sibling"}], locations: ["Taniquetil", "Valinor"], events: [], greatTales: [] },
  { id: "amras", name: "Amras", aliases: ["Telufinwë", "Ambarussa"], race: "Elfo Noldor", alignment: "good", role: "Séptimo hijo de Fëanor, gemelo de Amrod", description: "Séptimo hijo de Fëanor. Gemelo de Amrod. Los menores de los siete. Grandes cazadores.", details: "Amras fue el séptimo y último de los siete hijos de Fëanor y Nerdanel. Su nombre original era Telufinwë, aunque ambos gemelos compartían el nombre de Ambarussa. Como su hermano gemelo Amrod, Amras era uno de los menores de los Siete. Los gemelos eran cazadores excepcionales, heredando la pasión de Celegorm por la caza. A diferencia de sus hermanos mayores, que frecuentemente se veían envueltos en política y en los asuntos mayores de los Noldor, los gemelos mantuvieron una existencia más sencilla, dedicados a la caza y la compañía mutua.", titles: [{chapter: 9, text: "Séptimo hijo de Fëanor"}, {chapter: 9, text: "Gemelo de Amrod"}, {chapter: 9, text: "Gran cazador"}], notableDeeds: [{chapter: 9, text: "Hijo de Fëanor"}, {chapter: 9, text: "Cazador entre los Noldor"}], importance: "LOW", firstChapter: 9, relationships: [{characterId: "feanor", type: "father"}, {characterId: "nerdanel", type: "mother"}, {characterId: "maedhros", type: "sibling"}, {characterId: "maglor", type: "sibling"}, {characterId: "celegorm", type: "sibling"}, {characterId: "caranthir", type: "sibling"}, {characterId: "curufin", type: "sibling"}, {characterId: "amrod", type: "sibling"}], locations: ["Taniquetil", "Valinor"], events: [], greatTales: [] },
  { id: "denethor", name: "Denethor", aliases: ["Denethor de Ossiriand", "Señor de los Elfos Verdes"], race: "Elfo Nandor", alignment: "good", role: "Hijo de Lenwë, Señor de Ossiriand", description: "Líder de los Nandor que llegó a Ossiriand. Murió en la Primera Batalla de Beleriand defendiendo a su pueblo.", details: "Denethor fue el hijo de Lenwë, quien se había separado de los Teleri durante la Gran Marcha no deseando cruzar Hithaeglir. Cuando los Nandor llegaron finalmente a Beleriand, se asentaron en Ossiriand (la Tierra de los Siete Ríos), bajo el liderazgo de Denethor. Establecieron una comunidad tranquila, dedicada a la música y el arte, aunque alejada de los grandes reinos. Durante la Primera Batalla de Beleriand, cuando Morgoth fue repelido por los Sindar bajo Thingol, Denethor salió en defensa de Beleriand. Cayó heroicamente en Amon Ereb, la colina de protección del este. Su muerte marcó la primera pérdida noble en las batallas venieras y presagió las tragedias mayores que vendría.", titles: [{chapter: 11, text: "Señor de los Elfos Verdes"}, {chapter: 11, text: "Hijo de Lenwë"}, {chapter: 11, text: "El Valeroso"}], notableDeeds: [{chapter: 11, text: "Condujo a los Nandor a Ossiriand"}, {chapter: 11, text: "Participó en la Primera Batalla de Beleriand"}, {chapter: 11, text: "Cayó heroicamente en Amon Ereb"}], importance: "HIGH", firstChapter: 11, lastChapter: 11, deathInfo: { chapter: 11, description: "Murió en la Primera Batalla de Beleriand, cayendo en Amon Ereb. Su muerte fue valiente pero presagió las tragedias futuras." }, relationships: [{characterId: "lenwe", type: "father"}], locations: ["Ossiriand", "Amon Ereb"], events: ["Llegada a Ossiriand", "Primera Batalla de Beleriand"], greatTales: ["el-reino-sindar-primera-batalla"] },
  { id: "daeron", name: "Daeron", aliases: ["Daeron el Sabio", "Inventor de la Cirth"], race: "Elfo Sindar", alignment: "good", role: "Bardo y sabio de Doriath, inventor de la Cirth", description: "Bardo supremo y cantor de sabiduría de Doriath. Inventó la Cirth (runas élficas), sistema de escritura que rivalizaba con los Tengwar.", details: "Daeron fue el bardo y sabio de mayor renombre en la corte de Thingol en Menegroth. Dotado de gran talento musical y lingüístico, tuvo la visión de crear un sistema de escritura que complementara los Tengwar de Fëanor. La Cirth que inventó eran runas angulares más adecuadas para ser talladas en piedra o metal que los Tengwar, que habían sido diseñados para escritura con pluma. Su invención fue acto de genio comparable al de los Noldor, demostrando que la creatividad intelectual no se limitaba a Valinor. Aunque vivía en Doriath, bajo la Cintura de Melian, Daeron mantuvo contacto con el saber del mundo exterior, lo que le permitió crear un sistema que rivalizaba con las grandes invenciones élficas. Sus runas fueron adoptadas por muchos pueblos en las edades futuras.", titles: [{chapter: 11, text: "Bardo de Doriath"}, {chapter: 11, text: "Inventor de la Cirth"}, {chapter: 11, text: "Sabio de Thingol"}], notableDeeds: [{chapter: 11, text: "Inventó la Cirth"}, {chapter: 11, text: "Fue bardo supremo de Doriath"}], importance: "MEDIUM", firstChapter: 11, relationships: [{characterId: "thingol", type: "ally"}], locations: ["Menegroth", "Doriath"], events: ["Invención de la Cirth"], greatTales: ["el-reino-sindar-primera-batalla"] },
  { id: "telchar", name: "Telchar", aliases: ["Telchar el Sabio", "Mayor de los Herreros"], race: "Enano", alignment: "good", role: "Más grande de los herreros de Nogrod", description: "El más grande de todos los herreros de Nogrod. Sus obras rivalizaban con las de Fëanor en destreza, aunque no en magia.", details: "Telchar fue el maestro herrero más renombrado de los Enanos de Nogrod. Su genio en la forja era legendario, creando armas y objetos de tal destreza que rivalizaban incluso con las obras de los Noldor. Aunque los Enanos no poseían la magia que caracterizaba a la forja élfica, Telchar compensaba esto con técnica incomparable y visión artística. Trabajó en comisión para Thingol y los Sindar, proporcionando armas y armaduras de gran poder. Sus creaciones fueron buscadas por todos los pueblos de la Tierra Media. Aunque es poco lo que se sabe de su vida personal, su legado de herrería fue duradero y sus obras fueron recordadas a través de todas las edades.", titles: [{chapter: 11, text: "Maestro Herrero de Nogrod"}, {chapter: 11, text: "El Sabio"}], notableDeeds: [{chapter: 11, text: "Forjó armas y armaduras para Thingol"}, {chapter: 11, text: "Sus obras rivalizaban con las de los Noldor"}], importance: "LOW", firstChapter: 11, relationships: [], locations: ["Nogrod"], events: ["Forja de armas para Thingol"], greatTales: ["el-reino-sindar-primera-batalla"] }
];
...
export const locationsData: Location[] = [
  ...
  { id: "tirion", name: "Tirion", description: "La gran ciudad de los Elfos Noldor y Vanyar sobre la colina de Túna en Aman. Lugar de nacimiento de Fëanor y donde fueron inventadas las letras Tengwar por Rúmil y perfeccionadas por Fëanor. En sus plazas, Fëanor amenazó a su hermano Fingolfin cuando las mentiras de Melkor lo enceguecieron. Secretamente, los Noldor forjaron armas en preparación de la rebelión.", importance: "CRITICAL", type: "City", region: "Aman", status: "Active", firstChapter: 6, lat: 15, lng: -55, relatedCharacters: ["feanor", "fingolfin", "finarfin", "rumil", "miriel"], relatedEvents: ["t5", "t6", "t8a", "t8d"], greatTales: [] },
  { id: "formenos", name: "Formenos", aliases: ["La Fortaleza del Exilio"], description: "Fortaleza de Fëanor en el norte de Valinor, donde fue exiliado tras amenazar a Fingolfin. Guardó celosamente los Silmarils y rechazó a Melkor cuando este intentó robarlos.", importance: "HIGH", type: "Fortress", region: "Aman", status: "Destroyed", firstChapter: 8, lat: 25, lng: -58, ruler: { characterId: "feanor", period: "Capítulo 8-9" }, relatedCharacters: ["feanor", "finwe", "melkor"], relatedEvents: ["t8a", "t8d", "t8e"], greatTales: [] },
  ...
  { id: "ezellohar", name: "Ezellohar / Corollairë", aliases: ["Corollairë", "Montículo Verde", "Colina Roja"], description: "Montículo verde ante el portal occidental de Valimar. Consagrado por Yavanna. Regado por Nienna con lágrimas. Aquí cantó Yavanna la Canción de los Dos Árboles y de su canto nacieron Telperion y Laurelin. En el Capítulo 9, fue aquí donde Melkor y Ungoliant atacaron y destruyeron los Dos Árboles, extinguiendo su luz para siempre y sumiendo a Valinor en la Oscuridad. El montículo sagrado se convirtió en escena de la mayor tragedia de la Música.", importance: "CRITICAL", type: "Other", region: "Aman", status: "Active", firstChapter: 2, lastChapter: 9, lat: 21, lng: -62, relatedCharacters: ["yavanna", "nienna", "melkor", "ungoliant"], relatedEvents: ["Nacimiento de los Dos Árboles", "Destrucción de los Dos Árboles"], greatTales: ["fundacion-valinor-arboles", "destruccion-dos-arboles"] },
  ...
  { id: "alqualonde", name: "Alqualondë", aliases: ["Puerto de los Cisnes"], description: "Ciudad y puerto de los Teleri en los confines de Eldamar. Mansiones de perlas, naves con forma de cisnes con picos de oro. Portal: arco tallado en roca viva por las aguas. Olwë reinaba aquí como Rey de los Teleri. Fue escenario de la Matanza de Alqualondë en el Capítulo 10, cuando los Noldor atacaron a los Teleri para robar sus barcos.", importance: "CRITICAL", type: "City", region: "Aman", status: "Active", firstChapter: 6, lastChapter: 10, lat: 10, lng: -48, ruler: { characterId: "olwe", period: "Capítulo 6 en adelante" }, relatedCharacters: ["olwe", "earwen", "feanor", "fingolfin"], relatedEvents: ["Fundación de Alqualondë", "Kinslaying de Alqualondë"], greatTales: ["el-juramento-matanza"] },
  ...
  { id: "avathar", name: "Avathar", aliases: ["La Región de la Sombra", "Tierras del Sur"], description: "Región oscura al sur de las Pelóri, fuera de los límites de Valinor. Ninguna luz llegaba allí, pues estaba protegida de los resplandores de Valinor. Ungoliant habitaba en estas tierras oscuras, en cavernas bajo tierra, donde devoraba toda luz que pudiera entrar. Melkor encontró a Ungoliant aquí en su retorno secreto desde el este, antes de su gran ataque a los Dos Árboles.", importance: "HIGH", type: "Region", region: "Aman", status: "Active", firstChapter: 9, lat: 5, lng: -65, relatedCharacters: ["ungoliant", "melkor"], relatedEvents: ["Alianza de Melkor y Ungoliant"], greatTales: ["destruccion-dos-arboles"] },
  { id: "hyarmentir", name: "Hyarmentir", aliases: ["La Montaña del Lejano Suroeste", "Paso del Sur"], description: "La montaña más alta del sur, donde Melkor y Ungoliant cruzaron las Pelóri en la noche oscura del Oscurecimiento de Valinor. Su paso era muy elevado y peligroso, pero fue el único camino que Ungoliant pudo tomar sin ser detenida por los Guardias de los Valar. Desde aquí descendieron a la Tierra Media durante la noche.", importance: "HIGH", type: "Mountain", region: "Aman", status: "Active", firstChapter: 9, lat: 0, lng: -70, relatedCharacters: ["melkor", "ungoliant"], relatedEvents: ["Cruce del Pelóri por Hyarmentir"], greatTales: ["destruccion-dos-arboles"] },
  { id: "losgar", name: "Losgar", aliases: ["Hoguera de los Noldor", "Fuego de Losgar"], description: "Región donde los Noldor desembarcaron en la Tierra Media. Aquí fue donde Fëanor, en acto de determinación y traición, quemó los barcos de los Teleri y sus propios navíos, para que ninguno pudiera volver atrás. El fuego que se elevó de Losgar fue visible en toda la Tierra Media, y Morgoth lo vio desde Angband.", importance: "HIGH", type: "Region", region: "Beleriand", status: "Active", firstChapter: 10, lat: 72, lng: -200, relatedCharacters: ["feanor", "fingolfin", "finarfin"], relatedEvents: ["Quema de los barcos en Losgar"], greatTales: ["la-traicion-losgar"] },
  { id: "nogrod", name: "Nogrod", aliases: ["Ciudad de los Herreros", "Fortaleza Enana"], description: "Una de las dos grandes ciudades de los Enanos en la Tierra Media. Ubicada en las montañas al norte de Beleriand. Hogar de Telchar el Sabio, el más grande de los herreros. Nogrod fue centro de artesanía y comercio con los Sindar. Sus hereros crearon armas y joyas de incomparable poder.", importance: "HIGH", type: "City", region: "Beleriand", status: "Active", firstChapter: 11, lat: 70, lng: -90, relatedCharacters: ["telchar"], relatedEvents: ["Llegada de los Enanos a Beleriand"], greatTales: ["el-reino-sindar-primera-batalla"] },
  { id: "belegost", name: "Belegost", aliases: ["Gabilgathol", "Fortaleza de Belegost"], description: "La segunda de las dos grandes ciudades de los Enanos en las montañas del norte. Ubicada entre Nogrod y Menegroth. Sus herreros forjaron armas y armaduras para los Sindar. Belegost fue más amistosa con los Elfos que Nogrod, aunque ambas ciudades rivalizaban en el arte de la forja.", importance: "HIGH", type: "City", region: "Beleriand", status: "Active", firstChapter: 11, lat: 68, lng: -110, relatedCharacters: [], relatedEvents: ["Llegada de los Enanos a Beleriand"], greatTales: ["el-reino-sindar-primera-batalla"] },
  { id: "ossiriand", name: "Ossiriand", aliases: ["Tierra de los Siete Ríos", "Lindon Oriental"], description: "Región del este de Beleriand donde se asentaron los Nandor bajo el liderazgo de Denethor. Tierra de siete ríos: Ascar, Thalos, Legolin, Brithon, Gelion, Adurant y Anduril. Los Elfos Verdes vivieron aquí en paz, dedicados a la música y alejados de las grandes contiendas. Aunque aparentemente segura bajo la Cintura de Melian, Ossiriand fue la primera en caer a la invasión cuando Morgoth rompió el sitio.", importance: "MEDIUM", type: "Region", region: "Beleriand", status: "Active", firstChapter: 11, lat: 55, lng: -60, relatedCharacters: ["denethor"], relatedEvents: ["Llegada de Denethor y los Nandor", "Primera Batalla de Beleriand"], greatTales: ["el-reino-sindar-primera-batalla"] },
  { id: "amon-ereb", name: "Amon Ereb", aliases: ["Colina de la Defensa Aguda"], description: "Colina elevada del este de Beleriand, cerca de Ossiriand. Sitio de la muerte heroica de Denethor durante la Primera Batalla de Beleriand. Lugar simbólico de defensa contra los ataques de Morgoth desde el norte.", importance: "MEDIUM", type: "Mountain", region: "Beleriand", status: "Active", firstChapter: 11, lat: 60, lng: -50, relatedCharacters: ["denethor"], relatedEvents: ["Primera Batalla de Beleriand", "Muerte de Denethor"], greatTales: ["el-reino-sindar-primera-batalla"] },
  { id: "ered-gorgoroth", name: "Ered Gorgoroth", aliases: ["Montañas del Terror", "Montañas de la Oscuridad"], description: "Montañas del sur de Beleriand donde se escondió Ungoliant tras la destrucción de los Dos Árboles. Región terrible y desolada, habitada por criaturas arácnidas malévolas. Ungoliant se retiraba allí con sus vástagos, especie de arañas gigantes engendradas por ella.", importance: "MEDIUM", type: "Mountain", region: "Beleriand", status: "Active", firstChapter: 11, lat: 40, lng: -160, relatedCharacters: ["ungoliant"], relatedEvents: ["Retiro de Ungoliant"], greatTales: [] },
  { id: "sarn-athrad", name: "Sarn Athrad", aliases: ["Vado de Piedras"], description: "Ford sobre el Gelion en Beleriand Oriental. Sitio donde el Río Gelion fue cruzable. Localización importante en la región de Ossiriand y las tierras del este de Beleriand.", importance: "LOW", type: "Other", region: "Beleriand", status: "Active", firstChapter: 11, lat: 50, lng: -30, relatedCharacters: [], relatedEvents: [], greatTales: [] },
  { id: "monte-dolmed", name: "Monte Dolmed", aliases: ["Dolmed", "Montaña entre los Enanos"], description: "Montaña ubicada entre Nogrod y Belegost en las montañas del norte de Beleriand. Importante punto de referencia geográfico donde se encontraban las dos ciudades enanas.", importance: "LOW", type: "Mountain", region: "Beleriand", status: "Active", firstChapter: 11, lat: 68, lng: -100, relatedCharacters: [], relatedEvents: [], greatTales: [] }
];
...
export const timelineData: TimelineEvent[] = [
  ...
  { id: "t8a", year: "Años de los Árboles", title: "Creación de los Silmarils", description: "Fëanor forja las tres Silmarils, capturando la luz pura de los Dos Árboles de Valinor. Varda bendice las joyas con poder protector divino. Ningún fuego podría dañarlas, y solo el poder de Ilúvatar podría abrirlas o arrebatarlas.", importance: "CRITICAL", category: "Creation", firstChapter: 8, relatedCharacters: ["feanor", "varda"], relatedLocations: ["valinor"], greatTaleId: "creation-silmarils" },
  { id: "t8b", year: "Años de los Árboles", title: "Melkor siembra mentiras sobre la creación de armas", description: "Melkor instigó secretamente a los Noldor a forjar armas en preparación para una rebelión contra los Valar, afirmando falsamente que estos temían su poder. Las armas fueron forjadas en secreto en talleres ocultos de Tirion.", importance: "HIGH", category: "Creation", firstChapter: 8, relatedCharacters: ["melkor", "feanor"], relatedLocations: ["tirion"], greatTaleId: "" },
  { id: "t8c", year: "Años de los Árboles", title: "Amenaza de Fëanor a Fingolfin", description: "Enceguecido por las mentiras de Melkor, Fëanor desenvaina su espada contra su hermano Fingolfin en la plaza de Tirion. Fingolfin no responde con violencia, demostrando su nobleza. Los Valar son informados y decidem actuar.", importance: "CRITICAL", category: "Other", firstChapter: 8, relatedCharacters: ["feanor", "fingolfin", "manwe"], relatedLocations: ["tirion"], greatTaleId: "" },
  { id: "t8d", year: "Años de los Árboles", title: "Juicio y exilio de Fëanor", description: "Los Valar convocan consejo. Mandos, el Guardián de los Muertos, pronuncia un Hado de maldición sobre quien quebrantase los Silmarils: dolor, derrota y pérdida infinita les seguiría, incluso más allá de la muerte. Fëanor es juzgado y exiliado a Formenos. Finwë, por amor a su hijo, se retira con él.", importance: "CRITICAL", category: "Other", firstChapter: 8, relatedCharacters: ["mandos", "feanor", "finwe", "manwe"], relatedLocations: ["valinor", "formenos"], greatTaleId: "" },
  { id: "t8e", year: "Años de los Árboles (final)", title: "Retiro de Fëanor a Formenos", description: "Fëanor se retira a la fortaleza de Formenos en el norte de Valinor con sus leales. Los Silmarils son guardados bajo vigilancia constante dentro de la fortaleza. Finwë permanece con su hijo en solidaridad. La tensión en Valinor aumenta, y Mandos advierte que la maldición se cumplirá.", importance: "HIGH", category: "Journey", firstChapter: 8, relatedCharacters: ["feanor", "finwe"], relatedLocations: ["formenos"], greatTaleId: "" },
  { id: "t8f", year: "Años de los Árboles (final)", title: "Visita secreta de Melkor a Formenos", description: "En la noche oscura, Melkor visita secretamente Formenos, buscando robar los Silmarils de Fëanor o ganarse su alianza. Pero Fëanor lo descubre y lo rechaza violentamente, espada en mano. Melkor falla en su intento y comienza a preparar su huida de Valinor.", importance: "CRITICAL", category: "Other", firstChapter: 8, relatedCharacters: ["melkor", "feanor"], relatedLocations: ["formenos"], greatTaleId: "" },
  { id: "t8g", year: "Años de los Árboles (final)", title: "Huida de Melkor hacia la Tierra Media", description: "Melkor desaparece de Valinor y huye hacia la Tierra Media, dejando al Reino Bendecido en inquietud. Los Valar sospechan sus intenciones pero no comprenden aún la magnitud de la catástrofe que se aproxima. El viaje de Melkor marca el inicio del verdadero conflicto que consumirá la Primera Edad.", importance: "CRITICAL", category: "Journey", firstChapter: 8, relatedCharacters: ["melkor", "manwe"], relatedLocations: ["valinor", "angband"], greatTaleId: "" },
  { id: "t9a", year: "Años de los Árboles", title: "Melkor encuentra a Ungoliant en Avathar", description: "Melkor regresa en secreto del sur, viajando a través de la Tierra Media. En Avathar, la región oscura al sur de las Pelóri, encuentra a Ungoliant, una criatura de inteligencia malévola en forma de araña gigante que devoraba luz. Se alían: Melkor promete a Ungoliant acceso a la mayor luz de todas, los Dos Árboles de Valinor.", importance: "CRITICAL", category: "Other", firstChapter: 9, relatedCharacters: ["melkor", "ungoliant"], relatedLocations: ["avathar"], greatTaleId: "destruccion-dos-arboles" },
  { id: "t9b", year: "Años de los Árboles", title: "Melkor y Ungoliant cruzan el Pelóri", description: "Bajo la cobertura de la noche oscura, Melkor y Ungoliant cruzan las Montañas de Aman (Pelóri) por Hyarmentir, la montaña más alta del sur. Ningún Guardián de los Valar puede detenerlos. Descienden hacia Valinor con intención de muerte.", importance: "CRITICAL", category: "Journey", firstChapter: 9, relatedCharacters: ["melkor", "ungoliant"], relatedLocations: ["pelori", "hyarmentir", "valinor"], greatTaleId: "destruccion-dos-arboles" },
  { id: "t9c", year: "Años de los Árboles", title: "La Gran Fiesta en Taniquetil", description: "En Valinor, Manwë convoca una gran fiesta en Taniquetil, la montaña santa. Fëanor y Fingolfin, por largo tiempo enemigos, se reconcilian. Fingolfin abraza a Fëanor, y ambos pronuncian palabras de paz: 'Tú conducirás y yo te seguiré.' Pero esta reconciliación es breve, pues Melkor actúa esa misma noche.", importance: "CRITICAL", category: "Other", firstChapter: 9, relatedCharacters: ["manwe", "feanor", "fingolfin", "finwe"], relatedLocations: ["taniquetil", "valinor"], greatTaleId: "" },
  { id: "t9d", year: "Años de los Árboles", title: "Destrucción de los Dos Árboles", description: "Mientras Manwë celebra la fiesta, Melkor y Ungoliant atacan Ezellohar donde están los Dos Árboles. Ungoliant, con su hambre insaciable, bebe la savia de Telperion y Laurelin, devorando su luz. Los Árboles mueren, su luz se extingue para siempre. Arda pierde su fuente de iluminación más sagrada, y la Primera Edad entra en su mayor crepúsculo.", importance: "CRITICAL", category: "Destruction", firstChapter: 9, relatedCharacters: ["melkor", "ungoliant"], relatedLocations: ["ezellohar", "valinor"], greatTaleId: "destruccion-dos-arboles" },
  { id: "t9e", year: "Años de los Árboles", title: "El Oscurecimiento de Valinor", description: "Una Oscuridad No-Luz cae sobre Valinor: una sustancia maligna que Ungoliant tejió alrededor de su fuga. No es mera ausencia de luz sino un poder activo de tinieblas que envuelve todo. El Reino Bendecido es sumido en una penumbra de dolor. Melkor asesinó a Finwë en Formenos y robó los Silmarils, completando su venganza. Manwë ordena la persecución, pero el enemigo desaparece en la Oscuridad.", importance: "CRITICAL", category: "Destruction", firstChapter: 9, relatedCharacters: ["melkor", "ungoliant", "finwe", "manwe"], relatedLocations: ["valinor", "formenos", "ezellohar"], greatTaleId: "destruccion-dos-arboles" },
  { id: "t9f", year: "Años de los Árboles", title: "Persecución fallida de Melkor", description: "Oromë y otros Valar persiguen a Melkor y Ungoliant, cabalgando en rápida persecución. Pero la Oscuridad No-Luz que Ungoliant teje tras de sí los ciega; no pueden atravesar la Nube de Sombra. Melkor y su aliada desaparecen hacia la Tierra Media con los Silmarils robados, escapando de la Cólera de los Valar. La persecución es en vano.", importance: "CRITICAL", category: "Battle", firstChapter: 9, relatedCharacters: ["melkor", "ungoliant", "orome", "manwe"], relatedLocations: ["pelori", "valinor", "angband"], greatTaleId: "destruccion-dos-arboles" },
  { id: "t11a", year: "Años de los Árboles", title: "Nacimiento de Lúthien en Neldoreth", description: "Nace Lúthien Tinúviel, hija de Thingol y Melian, en el bosque de Neldoreth en Doriath. Se convierte en la más hermosa de todos los Hijos de Ilúvatar, heredando belleza y magia de su madre y el poder élfico de su padre.", importance: "CRITICAL", category: "Birth", firstChapter: 11, relatedCharacters: ["luthien", "thingol", "melian"], relatedLocations: ["doriath", "menegroth"], greatTaleId: "el-reino-sindar-primera-batalla" },
  { id: "t11b", year: "Años de los Árboles", title: "Llegada de los Enanos a Beleriand", description: "Los Enanos de Nogrod y Belegost llegan a Beleriand en busca de alianzas y comercio. Bajo el liderazgo de maestros como Telchar de Nogrod, ofrecen sus servicios de herrería y construcción a los Sindar de Doriath.", importance: "HIGH", category: "Journey", firstChapter: 11, relatedCharacters: ["thingol", "telchar"], relatedLocations: ["nogrod", "belegost", "menegroth", "doriath"], greatTaleId: "el-reino-sindar-primera-batalla" },
  { id: "t11c", year: "Años de los Árboles", title: "Construcción de Menegroth por los Enanos", description: "Los Enanos de Belegost, bajo el contrato de Thingol, comienzan la construcción de Menegroth, las Mil Cavernas. Tallada profundamente en la piedra bajo Doriath, con cámaras vastas y tesoros incomparables. La obra maestra de la construcción enana en la Tierra Media.", importance: "CRITICAL", category: "Creation", firstChapter: 11, relatedCharacters: ["thingol", "telchar"], relatedLocations: ["menegroth", "doriath", "belegost"], greatTaleId: "el-reino-sindar-primera-batalla" },
  { id: "t11d", year: "Años de los Árboles", title: "Llegada de Denethor y los Nandor a Ossiriand", description: "Denethor, hijo de Lenwë, llega a Ossiriand (la Tierra de los Siete Ríos) con su pueblo de Nandor. Se establece el reino de los Elfos Verdes bajo su liderazgo, separado pero relacionado con Doriath.", importance: "HIGH", category: "Journey", firstChapter: 11, relatedCharacters: ["denethor", "lenwe"], relatedLocations: ["ossiriand"], greatTaleId: "el-reino-sindar-primera-batalla" },
  { id: "t11e", year: "Años de los Árboles", title: "Daeron inventa la Cirth", description: "Daeron, el sabio bardo de Thingol en Doriath, inventa la Cirth (runas élficas). Este sistema de escritura, complementario a los Tengwar de Fëanor, es acto de genio intelectual que rivalizaba con las grandes invenciones de los Noldor.", importance: "HIGH", category: "Creation", firstChapter: 11, relatedCharacters: ["daeron", "thingol"], relatedLocations: ["menegroth", "doriath"], greatTaleId: "el-reino-sindar-primera-batalla" },
  { id: "t11f", year: "Años de los Árboles", title: "Primera Batalla de Beleriand", description: "Los Orcos de Morgoth atacan Beleriand. Los Sindar bajo Thingol y el pueblo de Denethor en Ossiriand se defienden valientemente. Aunque la batalla es ganada por los Elfos, Denethor cae heroicamente en Amon Ereb. Su muerte presagia las tragedias mayores que vendrían.", importance: "CRITICAL", category: "Battle", firstChapter: 11, relatedCharacters: ["thingol", "denethor", "melkor"], relatedLocations: ["beleriand", "amon-ereb", "ossiriand", "doriath"], greatTaleId: "el-reino-sindar-primera-batalla" },
  { id: "t11g", year: "Años de los Árboles", title: "Tejido de la Cintura de Melian", description: "Percibiendo el peligro venidero de Morgoth y sus Orcos, Melian teje la Cintura de Melian (Girdanor) alrededor del reino de Doriath. Esta frontera mágica, manifestación del poder de Melian, no puede ser atravesada ni penetrada sin su permiso. Doriath queda separado del resto de Beleriand, protegido pero aislado.", importance: "CRITICAL", category: "Creation", firstChapter: 11, relatedCharacters: ["melian", "thingol"], relatedLocations: ["doriath"], greatTaleId: "el-reino-sindar-primera-batalla" }
];
...
export const greatTalesData: GreatTale[] = [
  ...
  {
    id: "creation-silmarils",
    title: "La Creación de los Silmarils",
    description: "El relato de cómo Fëanor, el más dotado de los Elfos, forjó las tres Silmarils capturando la luz pura de los Dos Árboles de Valinor en joyas inigualables.",
    details: "Fëanor, inspirado por la belleza de los Dos Árboles y su luz incomparable, dedicó su genio a crear joyas que capturaran esa luz para siempre. Trabajó en secreto durante años, perfeccionando su técnica, hasta que logró forjar los Silmarils. Varda bendijo las joyas, protegiéndolas con poder divino. Sin embargo, la obsesión de Fëanor con su obra lo hizo vulnerable a la manipulación de Melkor, cuyas mentiras despertaron en él un codicioso apego que llevó a la maldición.",
    protagonists: ["feanor"],
    antagonists: ["melkor"],
    keyCharacters: ["varda", "finwe", "mahtan"],
    relatedLocations: ["valinor", "tirion"],
    relatedEvents: ["t8a"],
    themes: ["La Codicia del Creador por su Obra", "La Belleza Capturada", "El Poder y la Tentación"],
    needToKnow: [
      "Los Silmarils son joyas incomparables que contienen la luz pura de los Árboles.",
      "Fëanor forjó estas gemas tras años de trabajo dedicado y perfeccionamiento.",
      "Varda bendijo los Silmarils con protección divina.",
      "Su creación fue punto de partida para la tragedia de la Primera Edad."
    ],
    afterReadingShouldKnow: [
      "La belleza sin humildad se torna obsesión, y la obsesión atrae el mal.",
      "Los Silmarils simbolizan tanto la luz divina capturada como la maldad desatada por su codicia.",
      "Incluso la obra más bella puede ser semilla de destrucción si se apega a ella con orgullo."
    ],
    startChapter: 8,
    endChapter: 8
  },
  {
    id: "inquietud-noldor-caida-feanor",
    title: "La Inquietud de los Noldor y la Caída de Fëanor",
    description: "El relato de cómo las mentiras de Melkor envenenaron los corazones de los Noldor, especialmente el de Fëanor, llevando a su amenaza contra Fingolfin, su juicio, exilio y eventual ruptura de Valinor.",
    details: "Melkor, liberado de sus cadenas, se acercó a los Noldor con promesas de amistad, pero en realidad sembraba discordia. Convencía a Fëanor de que los Valar lo temían y lo celaban, que buscaban mantener a los Noldor como vasallos eternos. Sus mentiras encendieron el fuego de la rebelión en el corazón de Fëanor, quien en su ira desenvainó la espada contra su hermano Fingolfin en la plaza de Tirion. Los Valar lo juzgaron: Mandos pronunció un Hado de maldición. Fëanor fue exiliado a Formenos. Cuando Melkor intentó robar los Silmarils, Fëanor lo rechazó violentamente. Melkor huyó de Valinor, dejando semillas de ruina que germinarían durante toda la Primera Edad.",
    protagonists: ["feanor", "mandos"],
    antagonists: ["melkor"],
    keyCharacters: ["fingolfin", "finwe", "manwe"],
    relatedLocations: ["valinor", "tirion", "formenos"],
    relatedEvents: ["t8b", "t8c", "t8d", "t8e", "t8f", "t8g"],
    themes: ["La Mentira que se Cumple Sola", "La Nobleza Silenciosa de Fingolfin", "El Fuego del Orgullo"],
    needToKnow: [
      "Melkor sembró mentiras deliberadas entre los Noldor para sembrar discordia.",
      "Fëanor amenazó a Fingolfin en la plaza pública de Tirion.",
      "Fue juzgado por los Valar y exiliado a Formenos.",
      "Mandos pronunció un Hado de maldición sobre quien quebrantase los Silmarils.",
      "Melkor intentó robar los Silmarils pero fue rechazado por Fëanor."
    ],
    afterReadingShouldKnow: [
      "Los hermanos de una misma casa pueden ser enemigos mortales, divididos por mentiras y orgullo.",
      "Fingolfin demostró mayor nobleza al no responder a la amenaza de Fëanor con violencia.",
      "El juicio de los Valar fue justo, pero su clemencia temprana hacia Melkor resultó en tragedia mayor.",
      "El exilio de Fëanor a Formenos lo preparó secretamente para la rebelión venidera.",
      "La profecía de Mandos era irrevocable: el Hado de los Silmarils se cumpliría sin remedio."
    ],
    startChapter: 8,
    endChapter: 8
  },
  {
    id: "destruccion-dos-arboles",
    title: "La Destrucción de los Dos Árboles",
    description: "Melkor retorna en secreto desde el sur en alianza con Ungoliant, criatura de oscuridad que devora luz. Juntos cruzan las Pelóri. Mientras Fëanor y Fingolfin se reconcilian en la Gran Fiesta de Taniquetil, Melkor y Ungoliant atacan Ezellohar y destruyen los Dos Árboles de Valinor, asesinando al Rey Finwë y robando los Silmarils. La Oscuridad cae sobre el Reino Bendecido.",
    details: "En el Capítulo 9, la venganza de Melkor alcanza su apogeo. Tras su liberación de las cadenas, viajó en secreto a través de la Tierra Media hacia el sur, hasta Avathar, la región oscura fuera de Valinor donde ninguna luz llegaba. Allí encontró a Ungoliant, una criatura de inteligencia y maldad antigua, cuya forma era la de una araña gigante. Su hambre de luz era insaciable. Melkor se alió con ella, prometiéndole acceso a la mayor luz que existía: los Dos Árboles de Valinor, Telperion y Laurelin. Juntos, en la noche oscura, cruzaron las Pelóri por Hyarmentir, el paso más alto del sur, y descendieron a Valinor. Mientras Manwë convocaba una Gran Fiesta en Taniquetil para celebrar la reconciliación de Fëanor y Fingolfin (cuyas palabras de paz fueron 'Tú conducirás y yo te seguiré'), Melkor y Ungoliant atacaban Ezellohar, el montículo sagrado donde habitaban los Dos Árboles. Ungoliant, con su hambre insaciable de luz, bebió la savia de ambos Árboles, devorando su luminancia divina. Telperion y Laurelin, las creaciones más hermosas de Yavanna, murieron para siempre. Su luz nunca sería restaurada. Una Oscuridad No-Luz, sustancia maligna tejida por Ungoliant, cayó sobre Valinor como un manto de desesperación. Mientras tanto, Melkor se dirigió a Formenos, la fortaleza donde Finwë guardaba los Silmarils. Allí asesinó al Rey Finwë, el único Noldor asesinado directamente por Melkor, y robó los tres Silmarils. Luego huyó hacia la Tierra Media con Ungoliant. Manwë ordenó la persecución. Oromë cabalgó en su caballo blanco Nahar, pero la Oscuridad No-Luz los cegó, y no pudieron alcanzar a los fugitivos. Melkor escapó con los Silmarils robados, el Rey Noldor asesinado, y los Árboles destruidos. La mayor tragedia había ocurrido, y el Oscurecimiento de Valinor marca el fin de una era de paz en el Reino Bendecido.",
    protagonists: ["melkor", "ungoliant", "feanor", "fingolfin"],
    antagonists: ["finwe", "yavanna", "manwe"],
    keyCharacters: ["varda", "orome", "tulkas"],
    relatedLocations: ["avathar", "hyarmentir", "ezellohar", "formenos", "valinor", "taniquetil"],
    relatedEvents: ["t9a", "t9b", "t9c", "t9d", "t9e", "t9f"],
    themes: ["La Destrucción de lo Irrecuperable", "La Oscuridad como Cosa Viva", "El Momento Simultáneo", "La Alianza del Mal", "La Noche Eterna"],
    needToKnow: [
      "Melkor regresó en secreto del sur, aliado con Ungoliant, criatura de inteligencia y hambre de luz insaciable.",
      "Juntos cruzaron el Pelóri por Hyarmentir durante la noche oscura.",
      "Mientras se celebraba la reconciliación de Fëanor y Fingolfin, Melkor y Ungoliant destruyeron los Dos Árboles en Ezellohar.",
      "Los Dos Árboles Telperion y Laurelin murieron para siempre; su luz nunca sería restaurada.",
      "Melkor asesinó a Finwë en Formenos y robó los Silmarils, completando su venganza y marcando el fin de la paz en Valinor."
    ],
    afterReadingShouldKnow: [
      "Los Dos Árboles eran irrecuperables: su destrucción marca la entrada en un período de oscuridad de la que Valinor nunca se recuperaría completamente.",
      "Las palabras de reconciliación de Fëanor y Fingolfin, 'Tú conducirás y yo te seguiré', llevan ahora el peso de una terrible ironía: Fëanor conducirá los Noldor a la Tierra Media en rebelión.",
      "Finwë fue el único Noldor asesinado directamente por Melkor; su muerte fue más personal que la de cualquier otro, pues lo mató en el mismo acto de robar los Silmarils.",
      "La Oscuridad No-Luz no es ausencia de luz sino una sustancia maligna activa con peso y propósito; ella protege la fuga de Melkor y ciega a los perseguidores.",
      "Ungoliant creció enormemente al devorar la luz de los Árboles, pero incluso así, su hambre nunca fue saciada; más tarde exigirá una parte del botín y atacará a Melkor mismo."
    ],
    startChapter: 9,
    endChapter: 9
  },
  {
    id: "el-juramento-matanza-maldicion",
    title: "El Juramento, la Matanza y la Maldición",
    description: "La rebelión de los Noldor y sus primeros crímenes en la Tierra Media. Fëanor pronuncia el terrible Juramento que vincula a sus siete hijos. Los Noldor atacan a los Teleri en Alqualondë para robar sus barcos. Se cumplen las palabras de la Profecía de Mandos.",
    details: "Cuando Fëanor descubrió que Morgoth había robado los Silmarils y asesinado a su padre Finwë, su dolor se convirtió en fuego ardiente. Aunque Yavanna le imploró que devolviera las joyas para restaurar la luz de los Dos Árboles, Fëanor rehusó. En su lugar, pronunció un Juramento solemne y maldito: él y sus siete hijos se comprometieron a recuperar los Silmarils sin importar el costo, incluso si tenían que perseguir al Señor Oscuro hasta el fin del mundo. Este Juramento, pronunciado con poder mágico, los vinculó a un destino de dolor infinito. Los Noldor se rebelaron contra los Valar y marcharon hacia el oeste en busca de los Puertos de Cielo. En Alqualondë, la ciudad de los Teleri, Fëanor exigió que los Teleri le dieran sus barcos. Cuando se negaron, los Noldor los atacaron en una batalla que fue el primer derramamiento de sangre elfa: el Kinslaying de Alqualondë. Muchos Teleri cayeron, y los Noldor tomaron sus barcos. Mandos, desde Valinor, pronunció la Profecía del Norte, condenando a los Noldor y jurando que la sangre derramada entre hermanos los maldecería todas sus empresas futuras. Los Noldor estaban ahora encadenados por su propio juramento y maldecidos por sus propios actos.",
    protagonists: ["feanor", "maedhros"],
    antagonists: ["morgoth", "olwe"],
    keyCharacters: ["fingolfin", "finarfin", "mandos", "yavanna"],
    relatedLocations: ["alqualonde", "losgar", "helcaraxe", "taniquetil"],
    relatedEvents: ["Juramento de Fëanor", "Kinslaying de Alqualondë", "Profecía de Mandos"],
    themes: ["Juramento maldito", "Primer fratricidio", "Obsesión destructiva", "Consecuencias inevitables"],
    needToKnow: [
      "Fëanor pronunció un Juramento solemne: recuperar los Silmarils a cualquier costo",
      "Sus siete hijos quedaron vinculados por este Juramento",
      "El Kinslaying de Alqualondë fue el primer derramamiento de sangre elfa",
      "Mandos pronunció la Profecía del Norte condenando a los Noldor",
      "El Juramento se convirtió en maldición que persiguió a los Noldor en todos sus actos"
    ],
    afterReadingShouldKnow: [
      "El Juramento de Fëanor vinculó mágicamente a sus hijos a cumplirlo, incluso más allá de la muerte",
      "El Kinslaying fue un punto de no retorno: los Noldor se habían condenado a sí mismos",
      "Fingolfin fue abandonado sin barco y tuvo que cruzar el Helcaraxë a pie",
      "La Profecía de Mandos fue irrevocable: dolor, derrota y pérdida seguirían a los Noldor",
      "El Juramento y la Matanza marcaron el comienzo de la maldición que perduraría toda la Primera Edad"
    ],
    startChapter: 10,
    endChapter: 10
  },
  {
    id: "la-traicion-losgar-travesia",
    title: "La Traición de Losgar y la Travesía del Helcaraxë",
    description: "El abandono de Fingolfin en Losgar. La quema de los barcos. El terrible viaje de Fingolfin a través del Hielo Crujiente. El sufrimiento de los Noldor que perdieron sus vidas en el cruce.",
    details: "En Losgar, donde los Noldor desembarcaron en la Tierra Media, Fëanor tomó una decisión que marcaría para siempre el curso de la Edad: quemar todos los barcos. Su intención era doble: impedir que los Teleri los persiguieran, e impedir que ninguno de sus seguidores se arrepintiera y volviera a Valinor. Pero esta acción fue también una traición involuntaria a Fingolfin, quien había prometido seguir a Fëanor ('Tú conducirás y yo te seguiré'). Fingolfin se encontró abandonado sin medio de transporte, obligado a hacer un viaje casi imposible: cruzar el Helcaraxë, el Hielo Crujiente, a pie. Con su pueblo y los suyos, Fingolfin emprendió el viaje hacia el norte, en el terrible invierno. Muchos cayeron al hielo, perdidos en la oscuridad. Únicamente mediante la determinación inquebrantable de Fingolfin fue que su pueblo logró cruzar. El sufrimiento del Helcaraxë fue tan grande que Fingolfin nunca lo olvidó, y la amargura de ese abandono se grabó en su corazón para siempre. Sin embargo, Fingolfin no odiaba a Fëanor; su nobleza de carácter lo llevó a perdonar, aunque el dolor permanecería. La Travesía del Helcaraxë se convirtió en símbolo del sufrimiento de los Noldor, de su determinación incluso frente a lo imposible, y de la fragilidad de las promesas, incluso entre hermanos.",
    protagonists: ["fingolfin", "feanor"],
    antagonists: ["morgoth"],
    keyCharacters: ["fingon", "finarfin", "galadriel"],
    relatedLocations: ["losgar", "helcaraxe", "beleriand", "hithlum"],
    relatedEvents: ["Quema de los barcos en Losgar", "Cruce del Helcaraxë", "Llegada de Fingolfin a Beleriand"],
    themes: ["Traición involuntaria", "Sufrimiento noble", "Determinación inquebrantable", "Perdón entre hermanos"],
    needToKnow: [
      "Fëanor quemó los barcos en Losgar, abandonando a Fingolfin",
      "Fingolfin fue forzado a cruzar el Helcaraxë a pie en terrible sufrimiento",
      "Muchos de los Noldor murieron en el cruce del Hielo Crujiente",
      "A pesar del abandono, Fingolfin no resintió profundamente a Fëanor",
      "El cruce del Helcaraxë fue acto de suprema valentía y determinación"
    ],
    afterReadingShouldKnow: [
      "La quema de los barcos fue tanto acto de defensa como acto de traición involuntaria",
      "El sufrimiento de Fingolfin en el Helcaraxë prefigura su futuro heroísmo y también su eventual perdición",
      "El cruce del Helcaraxë demuestra que la determinación puede vencer incluso los obstáculos aparentemente imposibles",
      "La reconciliación de Fingolfin con Fëanor muestra la nobleza de carácter del Rey Supremo de los Noldor",
      "El Helcaraxë se convirtió en símbolo del sacrificio y el sufrimiento que los Noldor soportarían en la Tierra Media"
    ],
    startChapter: 10,
    endChapter: 10
  },
  {
    id: "el-reino-sindar-primera-batalla",
    title: "El Reino de los Sindar y la Primera Batalla de Beleriand",
    description: "La historia de cómo Thingol y Melian establecieron el reino más hermoso de Beleriand en Menegroth, y cómo la Primera Batalla enfrentó a los Sindar contra los Orcos de Morgoth, presagiando las tragedias que vendrían.",
    details: "Mientras los Noldor se rebelaban en Valinor y Fingolfin cruzaba el Helcaraxë, en Beleriand florecía un reino de paz y esplendor bajo el gobierno de Thingol y Melian. Thingol, transformado por su encuentro con la Maia más hermosa, gobernaba a los Sindar (Elfos Grises) con sabiduría y poder. De su unión nació Lúthien, la más hermosa de todos los Hijos de Ilúvatar. En el mismo período, los Enanos de Nogrod y Belegost llegaron a Beleriand buscando alianzas comerciales. Bajo la maestría de Telchar el Sabio, los herreros enanos trabajaron en la construcción de Menegroth, las Mil Cavernas, una ciudad de incomparable belleza tallada en la piedra bajo Doriath. Al mismo tiempo, Denethor y los Nandor llegaban a Ossiriand (la Tierra de los Siete Ríos) en el este, estableciendo su propio reino de Elfos Verdes. Daeron, el bardo de Thingol, inventaba la Cirth, un sistema de escritura que rivalizaba con los Tengwar de los Noldor. Pero la paz fue efímera. Morgoth, desde Angband, envió a sus Orcos contra Beleriand. En la Primera Batalla, Thingol y sus Sindar se enfrentaron a los ataques. Denethor salió en defensa del este, cayendo heroicamente en Amon Ereb. Aunque los Elfos ganaron la batalla, la muerte de Denethor presagió las tragedias mayores que vendrían. Percibiendo el peligro, Melian tejió la Cintura de Melian alrededor de Doriath, un cerco mágico de protección absoluta que separó a Doriath del resto del mundo. Doriath quedó seguro pero aislado, preparando el escenario para los eventos que marcarían el resto de la Primera Edad.",
    protagonists: ["thingol", "melian", "denethor"],
    antagonists: ["melkor"],
    keyCharacters: ["luthien", "daeron", "telchar", "cirdan"],
    relatedLocations: ["doriath", "menegroth", "nogrod", "belegost", "ossiriand", "amon-ereb"],
    relatedEvents: ["t11a", "t11b", "t11c", "t11d", "t11e", "t11f", "t11g"],
    themes: ["La paz que prepara la guerra", "La magia como protección", "La amistad entre razas", "El aislamiento que salva"],
    needToKnow: [
      "Thingol y Melian establecieron el reino más hermoso de Beleriand en Doriath",
      "Menegroth fue construida por los Enanos como obra maestra de arquitectura",
      "Lúthien nació como la más hermosa de todos los Hijos de Ilúvatar",
      "Los Enanos de Nogrod y Belegost fueron aliados de los Sindar en este período",
      "La Primera Batalla de Beleriand enfrentó a Thingol contra los Orcos de Morgoth",
      "Denethor murió heroicamente defendiendo Ossiriand en Amon Ereb",
      "Daeron inventó la Cirth, sistema de escritura rivalizando con los Tengwar",
      "Melian tejió la Cintura de Melian para proteger a Doriath"
    ],
    afterReadingShouldKnow: [
      "La paz de este período fue falsa; fue la calma antes de la tempestad",
      "La Cintura de Melian, aunque protegía a Doriath, también lo aisló del resto del mundo",
      "Los Enanos y Elfos compartían alianza comercial pero mantenían diferencias profundas",
      "La invención de la Cirth demuestra que la creatividad no se limitaba a los Noldor de Valinor",
      "La muerte de Denethor presagió las muertes heroicas de los Elfos que vendrían",
      "Este capítulo marca el apogeo de los reinos élficos antes de la llegada de los Noldor y los Hombres",
      "La magia de Melian fue el acto más poderoso de protección en la Tierra Media, pero eventual sería rota"
    ],
    startChapter: 11,
    endChapter: 11
  }
...
export const themesData: Theme[] = [
  ...
  {
    id: "greed-creator-work",
    name: "La Codicia del Creador por su Obra",
    analysis: "Fëanor creó los Silmarils como acto supremo de su genio, capturando la luz de los Dos Árboles. Sin embargo, su corazón se tornó posesivo respecto a sus creaciones. Cuando Melkor siembra mentiras sobre los Valar celosos, el orgullo de Fëanor en su obra se convierte en obsesión, y la obsesión en codicia. El Creador ama demasiado su creación, la quiere solo para sí, como si fuera su propiedad absoluta. Esta codicia del artista por su obra maestra es la puerta por la que entra la maldición. La lección es profunda: la creatividad sin desapego, sin disposición a soltar lo que hemos hecho, se convierte en un agrillete. El verdadero artista debe aprender a dejar ir su obra, confiarla al mundo, no aferrarse a ella como si fuera su identidad.",
    relatedGreatTales: ["creation-silmarils", "inquietud-noldor-caida-feanor"],
    relatedCharacters: ["feanor", "varda", "melkor"]
  },
  {
    id: "self-fulfilling-prophecy",
    name: "La Mentira que se Cumple Sola",
    analysis: "Melkor siembra en el corazón de Fëanor la mentira de que los Valar lo temen y desean destruir sus Silmarils. Esta mentira, aunque falsa en su origen, se convierte en profecía auto-cumplida. Fëanor, creyendo que sus creaciones están en peligro, toma acciones que llevan exactamente a lo que temía. Amenaza a Fingolfin, es exiliado, pronuncia un Juramento que lo condena a sí mismo y a sus hijos. Al final, sus acciones, motivadas por una mentira, resultan en la verdadera destrucción de los Silmarils y su familia. Melkor no necesita actuar violentamente; solo necesita mentir. Fëanor, a través de su propio orgullo y miedo, ejecuta la profecía del desastre. Este tema muestra la peligrosidad de la mentira: no es simplemente falsa información, sino un arma que manipula la voluntad del oidor para que trabaje en su propia ruina.",
    relatedGreatTales: ["inquietud-noldor-caida-feanor"],
    relatedCharacters: ["melkor", "feanor", "mandos"]
  },
  {
    id: "fingolfin-quiet-nobility",
    name: "La Nobleza Silenciosa de Fingolfin",
    analysis: "Cuando Fëanor desenvaina la espada contra Fingolfin en la plaza de Tirion, todos esperan que un rey réplique con violencia. Pero Fingolfin no lo hace. Su respuesta es el silencio noble: no desenvaina su espada, no replica insultos, no se deja arrastrar por la pasión de su hermano. Esta nobleza, más silenciosa que el grito de batalla, revela un carácter más fuerte que el de Fëanor. Fingolfin no necesita amenazas para ser rey; su poder está en su compostura, su cordura, su capacidad de controlar el fuego interior. Este tema se repetirá a lo largo de la Primera Edad: la verdadera nobleza no es grito sino silencio, no es violencia sino mesura, no es venganza sino perdón. Fingolfin representa el camino que Fëanor no pudo tomar, el camino de la sabiduría sobre la pasión, del amor sobre el orgullo.",
    relatedGreatTales: ["inquietud-noldor-caida-feanor"],
    relatedCharacters: ["fingolfin", "feanor"]
  },
  {
    id: "irreversible-destruction",
    name: "La Destrucción de lo Irrecuperable",
    analysis: "Los Dos Árboles de Valinor, Telperion y Laurelin, fueron las creaciones más hermosas de Yavanna. Fueron destruidos en el Capítulo 9 por Melkor y Ungoliant, y nunca fueron restaurados. Su luz nunca volvió a brillar. Este tema es fundamental en el Silmarillion: cada acción destructiva de Melkor deja un daño que no puede ser reparado. La simetría original de Arda fue rota cuando cayeron las Lámparas. Ahora la luz misma de Valinor es extinguida. El patrón se repetirá: los Silmarils serán perdidos, el reino de Gondolin será destruido, y todo lo que se intenta reconstruir será deficiente, incompleto. La pérdida es permanente. Este tema subraya la naturaleza existencial del conflicto: no es una batalla que pueda ganarse definitivamente, sino una lucha contra la entropía, contra la inevitable degradación del mundo.",
    relatedGreatTales: ["destruccion-dos-arboles", "irreversible-loss"],
    relatedCharacters: ["melkor", "ungoliant", "yavanna", "manwe"]
  },
  {
    id: "darkness-as-substance",
    name: "La Oscuridad como Cosa Viva",
    analysis: "La Oscuridad que cae sobre Valinor en el Capítulo 9 no es mera ausencia de luz, sino una sustancia viva, activa, con propósito y peso. Fue tejida por Ungoliant alrededor de su fuga, y ni siquiera los Valar pudieron atravesarla. La Oscuridad tiene inteligencia y maldad: protege a Melkor, ciega a los perseguidores, sofoca la esperanza. En el Silmarillion, la oscuridad nunca es simplemente lo opuesto a la luz, sino un poder activo en sí mismo, personificado en criaturas como Ungoliant y sustanciado en lugares como Angband. Este tema revela que el mal en el mundo de Tolkien no es ausencia sino presencia, no es pasivo sino activo, no es mero desorden sino orden maligna. La Oscuridad tiene forma, tiene voluntad, tiene poder de acción. Comprenderlo es comprender que la lucha contra el mal no es una lucha contra la nada, sino contra un enemigo tangible que puede ser tanto resistido como amplificado.",
    relatedGreatTales: ["destruccion-dos-arboles"],
    relatedCharacters: ["ungoliant", "melkor", "manwe", "orome"]
  },
  {
    id: "simultaneous-moment",
    name: "El Momento Simultáneo",
    analysis: "En el Capítulo 9, varios eventos ocurren simultáneamente pero de manera significativa. Mientras Fëanor y Fingolfin se reconcilian en Taniquetil pronunciando palabras de paz ('Tú conducirás y yo te seguiré'), en el mismo instante Melkor y Ungoliant atacan los Dos Árboles en Ezellohar. Mientras Manwë celebra la fiesta, Finwë muere en Formenos. Esta simultaneidad no es casual; revela una estructura más profunda del universo de Tolkien en que los actos de bien y mal están entrelazados, en que cada reconciliación lleva consigo una sombra de desastre, en que la paz es siempre frágil y temporal. El tema sugiere que la historia no es una simple progresión lineal sino un tejido complejo donde múltiples hilos se entrecruzan. La reconciliación de Fëanor y Fingolfin ocurre precisamente en el momento en que todo se pierde, dando a sus palabras una ironía terrible que resuena a lo largo de las edades. Este tema subraya que en el mundo del Silmarillion, los tiempos se entrelazan: el bien y el mal, la victoria y la derrota, la reconciliación y la traición acontecen en el mismo latido del corazón del mundo.",
    relatedGreatTales: ["destruccion-dos-arboles"],
    relatedCharacters: ["feanor", "fingolfin", "melkor", "finwe", "manwe"]
  },
  {
    id: "oath-self-imposed-trap",
    name: "El Juramento como Trampa Autoimpuesta",
    analysis: "El Juramento de Fëanor es un punto de quiebre en el Silmarillion. No es impuesto por los Valar ni por Morgoth, sino que Fëanor lo pronuncia voluntariamente. Sin embargo, una vez pronunciado, sus palabras adquieren poder mágico y vinculante. Los siete hijos de Fëanor quedan vinculados a este juramento irrevocable. El tema central es que la libertad puede llevar a la auto-esclavitud: al pronunciar el juramento, Fëanor se ata a sí mismo a un destino de dolor infinito. Cada hijo de Fëanor, aunque posee libertad de elección, está ahora encadenado por las palabras de su padre. El Silmarillion sugiere que las palabras tienen poder mágico, que los actos de habla pueden crear realidades que no pueden ser deshechas. Esto es particularmente verdadero para los Elfos, cuyas palabras en actos de suprema emoción adquieren peso cósmico. La trampa es autoimpuesta porque Fëanor tenía libertad de no hacer el juramento, pero una vez pronunciado, ningún poder en Arda podría liberarlos de él.",
    relatedGreatTales: ["el-juramento-matanza-maldicion"],
    relatedCharacters: ["feanor", "maedhros", "mandos"]
  },
  {
    id: "first-fratricide",
    name: "El Primer Fratricidio",
    analysis: "El Kinslaying de Alqualondë es el primer fratricidio entre Elfos. Es un momento determinante en el Silmarillion: por primera vez, Elfos matan a Elfos. Aunque Melkor es la fuente del mal, son los Noldor quienes cometen el acto. La Matanza no fue acto de Morgoth sino de sus propios hermanos, los Teleri, quienes se negaban a entregar sus barcos. Fëanor insistió en tomar los barcos por la fuerza, llevando a un baño de sangre. Este fratricidio es crucial porque marca un punto de no retorno para los Noldor. El Hado de Mandos pronuncia que este primer crimen será seguido de muchos más, que la sangre derramada entre hermanos maldecirá todas sus empresas futuras. El tema explora cómo el orgullo y la obsesión pueden llevar a los buenos a cometer actos terribles. Los Noldor no son conquistadores malvados; son seres que aman la luz y la libertad, pero sus propias pasiones los ciegan. El primer fratricidio es tanto tragedia como advertencia: incluso los más nobles pueden ser arrastrados al mal si ceden a la obsesión.",
    relatedGreatTales: ["el-juramento-matanza-maldicion"],
    relatedCharacters: ["feanor", "fingolfin", "olwe", "mandos"]
  },
  {
    id: "brother-betrays-brother",
    name: "La Traición del Hermano al Hermano",
    analysis: "Aunque Fëanor y Fingolfin se reconciliaron en Taniquetil, pronunciando palabras de paz, el Capítulo 10 revela la traición última: Fëanor abandona a Fingolfin y a sus seguidores al quemar los barcos en Losgar. Fingolfin es dejado sin medio de transporte, forzado a cruzar el Helcaraxë a pie en terrible sufrimiento. Aunque la quema de los barcos fue un acto defensivo (evitar que los Teleri u otros los siguieran), fue también una traición a Fingolfin, quien había jurado seguir a Fëanor. La palabra de Fingolfin 'Tú conducirás y yo te seguiré' se convierte en una promesa que sólo puede ser cumplida a través de sufrimiento casi mortal. El tema subraya que incluso entre hermanos, incluso entre quienes se aman, la pasión obsesiva puede generar traición involuntaria. Fingolfin no resiente a Fëanor (aunque ciertamente sufre), pero la traición está ahí, tejida en el tejido de eventos. La traición del hermano al hermano es quizás el más doloroso de todos los pecados en el Silmarillion porque viola la más íntima de las lealtades.",
    relatedGreatTales: ["la-traicion-losgar-travesia"],
    relatedCharacters: ["feanor", "fingolfin", "fingon"]
  },
  {
    id: "peace-prepares-war",
    name: "La Paz que Prepara la Guerra",
    analysis: "En el Capítulo 11, mientras Thingol y Melian establecen un reino de paz y belleza en Doriath, mientras Menegroth es construida como ciudad de esplendor, mientras Denethor planta los jardines de Ossiriand, todo parece ser la culminación de la civilización élfica. Pero esta paz es falsa, una calma antes de la tempestad. Cada acto de construcción, cada invención (como la Cirth de Daeron), cada alianza (como la de los Enanos con los Sindar) está siendo forjada como arma o escudo para la guerra venidera. La paz no es el fin sino la preparación. La Primera Batalla, en la cual Denethor cae, es anticipo de guerras mayores. La invención de la magia de Melian y el tejido de la Cintura es acto de defensa anticipada. El tema sugiere que en el Silmarillion, la paz es siempre temporal, y la verdadera historia no es de tiempos tranquilos sino de preparación constante para conflictos inevitables.",
    relatedGreatTales: ["el-reino-sindar-primera-batalla"],
    relatedCharacters: ["thingol", "melian", "denethor"]
  },
  {
    id: "girdle-melian-frontier",
    name: "La Cintura de Melian como Frontera entre Mundos",
    analysis: "La Cintura de Melian, tejida alrededor de Doriath como frontera mágica, es mucho más que una simple barrera defensiva. Es la manifestación tangible del poder de Melian, una frontera entre el mundo normal y el mundo protegido. A través de la Cintura, Doriath se separa del resto de Beleriand, creando un espacio aparte, casi fuera del tiempo. Los que entran cruzan una frontera entre mundos: dejan atrás la lucha y la muerte, entrando en un reino de paz y magia. Pero como toda frontera mágica, tiene un costo: el aislamiento. Doriath es seguro pero apartado, protegido pero incomunicado. La Cintura simboliza la paradoja del poder defensivo: la protección requiere separación, la seguridad requiere aislamiento. Este tema es central para entender el futuro de Doriath: protegido por Melian, pero vulnerables cuando esa protección falle.",
    relatedGreatTales: ["el-reino-sindar-primera-batalla"],
    relatedCharacters: ["melian", "thingol"]
  },
  {
    id: "cold-friendship-dwarves-elves",
    name: "La Amistad Fría entre Enanos y Elfos",
    analysis: "En el Capítulo 11, los Enanos de Nogrod y Belegost llegan a Beleriand y se alían con los Sindar. Los maestros herreros como Telchar colaboran con Thingol en la construcción de Menegroth. Es una alianza de conveniencia mutua: los Enanos desean comercio y la oportunidad de trabajar en proyectos grandiosos; los Elfos desean las habilidades únicas de los herreros enanos. Pero esta amistad es siempre 'fría': hay una diferencia cultural profunda entre Elfos y Enanos que nunca es completamente superada. Los Elfos ven a los Enanos como artesanos y aliados comerciales pero no como verdaderos amigos. Los Enanos respetan la belleza y poder de los Elfos pero nunca del todo los confían. Esta amistad fría será fuente de futuros conflictos: en el Capítulo 23, los Enanos de Nogrod asesinaran a Thingol por el collar Nauglamír y el Silmaril, demostrando que la alianza nunca fue tan fuerte como parecía. El tema sugiere que la amistad verdadera requiere comprensión profunda, y que sin ella, la alianza es siempre frágil, susceptible a traición por dinero o poder.",
    relatedGreatTales: ["el-reino-sindar-primera-batalla"],
    relatedCharacters: ["telchar", "thingol"]
  }
];
